...
The full parameter-inference record, specimen-specific values, postprocessor chain, and proposed manuscript appendix are stored in `BOUNDARY_PENALTY_LOADING_AND_VALUE_INFERENCE.md` in this directory.
