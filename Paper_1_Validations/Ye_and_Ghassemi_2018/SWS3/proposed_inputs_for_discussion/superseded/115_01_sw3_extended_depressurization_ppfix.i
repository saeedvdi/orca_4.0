...
# Purpose: Kalantar-type diagnostic: extend post-slip depressurization from 7.88 MPa to 6.5 MPa and then the 5.75 MPa pre-cycle pressure.
# Parent deck: 110_01_sw3_floor1nm_g040_ppfix.i; every unlisted parameter is unchanged.

# =============================================================================
# 110_01 -- SW-S3 calibrated hydraulic mechanisms with a relaxed aperture floor
#
# Parent: 100_06_sw3_resc1p30_unld0p00_ppfix.i
# Controlled change: min_hydraulic_aperture 1.22e-6 -> 1.0e-9 m.
# Purpose: determine whether the calibrated SW-S3 response is independent of the
#          lower aperture bound, using the same control logic as SW-S4 run 109_01.
# All mechanics, pressure coupling, dilation, roughness, and gouge parameters are
# unchanged. This is a diagnostic control, not a recalibrated validation case.
# =============================================================================
# =============================================================================
# 100_06 REFINEMENT PROBE -- SW-S3
# Parent physics: 99_06 residual cohesion 1.30 MPa plus the unloading direction
# tested by 99_05, continued from retention 0.03 to its physical lower bound 0.
# The additive response predicts mean nRMSE near 4.35%; the run tests whether
# late normal-closure gain survives coupling without further shear-slip damage.
# =============================================================================
# =============================================================================
# 99_06 CONTROLLED CALIBRATION PROBE -- SW-S3
# Parent: 93_05_sw3_final_resc1p40_ppfix.i
# One material axis only: residual cohesion 1.40 -> 1.30 MPa.
# Hypothesis: reduce the post-event stress bias while avoiding the displacement
# penalty observed at the older 1.20 MPa bracket.
# =============================================================================
# =============================================================================
...
# --- mesh / geometry ---
mesh_file = ../mesh/sw3_mesh_L123p4_size5.e  # input is stored in SWS3/proposed_inputs
...
min_hydraulic_aperture = 1.0e-9      # 110_01 diagnostic: relax the 1.22 um benchmark floor
...
# --- output ---
exodus_file_base = proposed_inputs/paper_compelling_20260902/exodus/115_01_sw3_extended_depressurization_ppfix
csv_file_base    = proposed_inputs/paper_compelling_20260902/csv/115_01_sw3_extended_depressurization_ppfix
checkpoint_file_base = proposed_inputs/paper_revision_20260901_sw3_followup/checkpoint/115_01_sw3_extended_depressurization_ppfix
...
[Materials]
  ...
  [czm_contact]
    ...
    normal_unload_retention_fraction = 0.00 # 100_06: physical lower-bound unloading bracket
    ...
    residual_cohesion = 1.30e6   # 99_06: midpoint between the 1.40 and 1.20 MPa brackets
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 5802.4  # original cycle plus two lower-pressure holds
