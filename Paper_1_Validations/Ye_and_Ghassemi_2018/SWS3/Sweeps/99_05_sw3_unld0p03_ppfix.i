# =============================================================================
# 99_05 CONTROLLED CALIBRATION PROBE -- SW-S3
# Parent: 93_05_sw3_final_resc1p40_ppfix.i
# One material axis only: normal unload retention 0.06 -> 0.03.
# Hypothesis: recover more closure on the unloading branch. Strength, slip
# weakening, dilation, and hydraulic parameters are unchanged.
# =============================================================================
# =============================================================================
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/99_05_sw3_unld0p03_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/99_05_sw3_unld0p03_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/99_05_sw3_unld0p03_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    normal_unload_retention_fraction = 0.03 # 99_05: targeted unloading-branch bracket
