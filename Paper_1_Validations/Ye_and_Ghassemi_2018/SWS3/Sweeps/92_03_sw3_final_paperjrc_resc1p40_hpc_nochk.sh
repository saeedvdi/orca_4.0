...
#SBATCH --job-name=92_03_sw3_final_paperjrc_resc1p40_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/92_03_sw3_final_paperjrc_resc1p40_hpc_%j.out
#SBATCH --error=logs/92_03_sw3_final_paperjrc_resc1p40_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 92_03_sw3_final_paperjrc_resc1p40.i \
