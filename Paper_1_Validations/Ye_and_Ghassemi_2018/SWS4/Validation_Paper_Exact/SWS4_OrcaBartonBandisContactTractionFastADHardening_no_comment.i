...
# the previous name of this file was 93_07_sw4_final_theta30_jrc5_ppfix_hpc
#
...
youngs_modulus = 67e9 # Pa, Paper Value
poissons_ratio = 0.32 # Paper Value
strain_model = incremental
initial_stress = '-31e6 -31e6 -31e6'
biot_coefficient = 0.6 # inferred

# --- matrix HM ---
initial_porosity = 0.001 # inferred
matrix_permeability = 5e-19          # m^2, paper value

# --- loading ---
confining_pressure = 30e6  # Pa Paper value
production_pressure = 5e6            # Pa, Paper Value
...
# --- output ---
exodus_file_base = results_exodus/SWS4_OrcaBartonBandisContactTractionFastADHardening
csv_file_base    = results_csv/SWS4_OrcaBartonBandisContactTractionFastADHardening
checkpoint_file_base = results_checkpoint/SWS4_OrcaBartonBandisContactTractionFastADHardening
