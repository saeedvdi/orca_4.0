# =============================================================================
# 105_07 CALIBRATED MOHR-COULOMB UPPER BOUND -- SWS4
# Parent: 94_07_sw4_mc_final.i   Envelope source: orca_3.0_full deck 67_11
#
# SW-S4 calibrated Mohr-Coulomb (envelope only, rate-and-state OFF).
#
...
dilation_angle_peak_degrees = 50.0   # 105_07: 67_11; 94_07 used 24.0
...
dilation_angle_residual_degrees = 22.0   # 105_07: 67_11; 94_07 used 13.0
...
bb_roughness_characteristic_slip = 1.15e-4   # 105_07: 67_11 D_R; 94_07 used 8.0e-5 (the BBFast roughness distance)
#
# (e) NUMERICS / RATE (as deck 43):
normal_traction_tolerance = 0.0
tangential_traction_tolerance = 1e-16
max_plastic_slip_increment = 0.0
tangential_viscosity = 5.0e12   # 105_07: 67_11; 94_07 used 3.5e12
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/105_07_sw4_mc_calib_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/105_07_sw4_mc_calib_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/105_07_sw4_mc_calib_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    friction_coefficient_rough = 1.17   # 105_07: 67_11; was 0.9804 (BB tangent transfer)
    friction_coefficient_smooth = 0.055   # 105_07: 67_11; was 0.1139
    friction_roughness_exponent = 1.0     # linear in Rbar, matching BB's linear-in-W form
    cohesion_rough = 0.0   # 105_07: 67_11 COHESIONLESS; was 3.225e6
    cohesion_smooth = 0.0   # 105_07: 67_11 COHESIONLESS
    cohesion_roughness_exponent = 2.0   # 105_07: 67_11; was 1.0
