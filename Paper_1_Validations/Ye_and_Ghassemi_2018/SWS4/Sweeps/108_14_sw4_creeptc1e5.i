# =============================================================================
# 108_14 -- SWS4 -- closure creep tau_c = 1e5 s
#
...
#   a_c_max = 0.0207 um = this run's own retained gain, a_h(T_p) - a_h0.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/108_14_sw4_creeptc1e5
csv_file_base    = results_csv_hpc_rorqual/108_14_sw4_creeptc1e5
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_14_sw4_creeptc1e5
...
[Materials]
  ...
  [czm_aperture]
    ...
    closure_creep_max_aperture = 2.07e-08
    closure_creep_time = 100000
    closure_creep_reference_stress = 31.0e6
...
[Executioner]
  ...
  dtmax = 2000   # 108: parent 1.5; the FunctionDT in [TimeSteppers] still enforces 1.5 up to t = 3500 s
