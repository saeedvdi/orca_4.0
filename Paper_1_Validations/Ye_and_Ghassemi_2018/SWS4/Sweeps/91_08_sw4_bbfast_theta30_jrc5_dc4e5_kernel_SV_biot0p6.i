# =============================================================================================
# 91_08_sw4_bbfast_theta30_jrc5_dc4e5_kernel_SV_biot0p6
#
...
#
# THIS DECK.  The other side of the SW-S4 D_c bracket:
# bb_characteristic_slip_distance 7.45e-5 -> 4.0e-5 m (74.5 -> 40 um).  Parent 90_08.
#
# WHY RUN THE WRONG DIRECTION ON PURPOSE.  91_07 argues that a LONGER D_c spreads the transition
# and recovers SW-S4's staged response.  That argument is only worth anything if the opposite
# move makes the staging worse in a measurable way.  At D_c = 40 um the measured 80 um of slip
# is 2 D_c -- the joint is fully residual almost immediately and the event should collapse into
# a single sharper drop with the intermediate stages even later than 90_08's 59-90 s.
#
# If 91_08 instead scores as well as 91_07, D_c does NOT control the transition duration on this
# specimen and the staged response is a model-form limit (no rate dependence, no asperity-scale
# heterogeneity) rather than a parameter.  That is a useful negative result and it is cheaper to
# buy here than to argue about in review.
#
# =============================================================================================
# ==============================================================================
...
bb_characteristic_slip_distance = 4.0e-5 # 67_01: in-bracket midpoint; trims stress with only ~0.3um predicted slip cost.  # 91_08: 74.5 -> 40 um, see header. Was 7.45e-5.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/91_08_sw4_bbfast_theta30_jrc5_dc4e5_kernel_SV_biot0p6_hpc
csv_file_base    = results_csv_hpc_rorqual/91_08_sw4_bbfast_theta30_jrc5_dc4e5_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/91_08_sw4_bbfast_theta30_jrc5_dc4e5_kernel_SV_biot0p6_hpc
