# =============================================================================
# 108_06 -- SWS4 -- reconfinement to 3.5x sigma_3
#
# Parent: 93_07_sw4_final_theta30_jrc5_ppfix.i  (unchanged except where listed below)
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/108_06_sw4_reconf3p5x
csv_file_base    = results_csv_hpc_rorqual/108_06_sw4_reconf3p5x
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_06_sw4_reconf3p5x
...
[Executioner]
  ...
  dtmax = 2   # 108: parent 1.5; the FunctionDT in [TimeSteppers] still enforces 1.5 up to t = 3500 s
