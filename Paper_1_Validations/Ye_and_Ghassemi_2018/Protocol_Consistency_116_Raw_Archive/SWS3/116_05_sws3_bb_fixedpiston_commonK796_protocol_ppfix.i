################################################################################
# ACTIVE PROTOCOL-CONSISTENCY CASE: 116_05_sws3_bb_fixedpiston_commonK796_protocol_ppfix
# Generated by build_protocol_consistency_inputs.py; parent deck is unchanged.
# Model/specimen: BB / SWS3
# COMMON MACHINE SPRING: K_sys = 796 kN/mm and
# k_p = K_sys/A = 396939748231 Pa/m.
...
axial_pres_initial = -7.80974949930904e-05
axial_pres_final = -0.000216230367577228
...
# --- output ---
exodus_file_base = proposed_inputs/protocol_consistency_20260902/exodus/116_05_sws3_bb_fixedpiston_commonK796_protocol_ppfix
csv_file_base = proposed_inputs/protocol_consistency_20260902/csv/116_05_sws3_bb_fixedpiston_commonK796_protocol_ppfix
checkpoint_file_base = proposed_inputs/protocol_consistency_20260902/checkpoint/116_05_sws3_bb_fixedpiston_commonK796_protocol_ppfix
...
[Mesh]
  ...
  [source_in]
    ...
    coord = '-0.019265000 0.0 0.026945020'   # requested 6.0 mm sidewall target; closest mesh node is selected
  ...
  [source_out]
    type = ExtraNodesetGenerator
    input = source_in
    coord = '0.019265000 0.0 0.096454980'   # requested 6.0 mm sidewall target; closest mesh node is selected
...
[Postprocessors]
  ...
  [injection_pressure_pp]
    type = PointValue
    variable = pore_pressure
    point = '-0.019265000 0.0 0.026945020'  # L123p4: must track the source_in coord above
  []
  [inj_reaction_sum_pp]
    type = NodalSum
  ...
  [pp_outlet_pp]
    type = PointValue
    variable = pore_pressure
    point = '0.019265000 0.0 0.096454980'  # L123p4: must track the source_out coord above
  []
  [pp_drop_pp]
    type = ParsedPostprocessor
