################################################################################
# ACTIVE PROTOCOL-CONSISTENCY CASE: 116_08_sws4_mc_fixedpiston_commonK796_protocol_ppfix
# Generated by build_protocol_consistency_inputs.py; parent deck is unchanged.
# Model/specimen: MC / SWS4
# COMMON MACHINE SPRING: K_sys = 796 kN/mm and
# k_p = K_sys/A = 397254155940 Pa/m.
...
axial_bc_penalty = 397254155940
axial_pres_initial = -7.80356845522487e-05
axial_pres_final = -0.00019823612370696
...
side_unload_relax_pressure = 0.0
...
bb_roughness_characteristic_slip = 8e-05
#
...
# --- output ---
exodus_file_base = proposed_inputs/protocol_consistency_20260902/exodus/116_08_sws4_mc_fixedpiston_commonK796_protocol_ppfix
csv_file_base = proposed_inputs/protocol_consistency_20260902/csv/116_08_sws4_mc_fixedpiston_commonK796_protocol_ppfix
checkpoint_file_base = proposed_inputs/protocol_consistency_20260902/checkpoint/116_08_sws4_mc_fixedpiston_commonK796_protocol_ppfix
...
[Mesh]
  ...
  [source_in]
    ...
    coord = '-0.019255000 0.0 0.025999536'   # requested 6.0 mm sidewall target; closest mesh node is selected
  ...
  [source_out]
    type = ExtraNodesetGenerator
    input = source_in
    coord = '0.019255000 0.0 0.092700464'   # requested 6.0 mm sidewall target; closest mesh node is selected
