...
# Purpose: Time-step robustness: halve the SW-S4 maximum step from 1.5 to 0.75 s.
...
# --- output ---
exodus_file_base = proposed_inputs/paper_compelling_20260902/exodus/112_03_sw4_dt075_ppfix
csv_file_base    = proposed_inputs/paper_compelling_20260902/csv/112_03_sw4_dt075_ppfix
checkpoint_file_base = paper_revision_20260901_followup/checkpoint/112_03_sw4_dt075_ppfix
...
[Executioner]
  ...
  [TimeStepper]
    ...
    dt = 0.75                  # conservative transition cadence; v12 rejected ~1.93 s around the first slip jumps
