# =============================================================================
# 108_10 -- SWT2 -- retention lag tau = 1500 s
#
...
#
# CHANGES FROM PARENT
#   1. end_time 2852.53 -> 62852.5 s (the paper protocol is untouched up to 2852.53 s;
...
exodus_file_base = results_exodus_hpc_rorqual/108_10_swt2_unldtau1500
csv_file_base    = results_csv_hpc_rorqual/108_10_swt2_unldtau1500
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_10_swt2_unldtau1500
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.0 60.0 130.0 480.0 565.0 995.0 1070.0 1360.0 1460.0 1755.0 1850.0 2145.0 2280.0 2500.0 2510.0 2560.0 2570.0 2605.0 2615.0 2650.0 2660.0 2705.0 2725.0 2830.0 2852.5 62852.5'
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 62852.5   # 108: protocol ends at 2852.53 s; the rest is the hold
  ...
  dtmax = 100   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 2852.53 s
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
