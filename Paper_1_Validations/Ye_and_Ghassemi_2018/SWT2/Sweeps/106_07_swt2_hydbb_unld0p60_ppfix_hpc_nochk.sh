...
#SBATCH --job-name=106_07_swt2_hydbb_unld0p60_ppfix_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/106_07_swt2_hydbb_unld0p60_ppfix_hpc_%j.out
#SBATCH --error=logs/106_07_swt2_hydbb_unld0p60_ppfix_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 106_07_swt2_hydbb_unld0p60_ppfix.i \
