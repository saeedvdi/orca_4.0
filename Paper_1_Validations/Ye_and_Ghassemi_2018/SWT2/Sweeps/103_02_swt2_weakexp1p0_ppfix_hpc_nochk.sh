...
#SBATCH --job-name=103_02_swt2_weakexp1p0_ppfix_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/103_02_swt2_weakexp1p0_ppfix_hpc_%j.out
#SBATCH --error=logs/103_02_swt2_weakexp1p0_ppfix_hpc_%j.err
...
#
# 3803 steps at dtmax = 0.75; measured 1.39 s/step on 32 ranks for a mesh-5 deck
# of this size, i.e. ~1.5 h.  --time=06:00:00 leaves generous margin.
#
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 103_02_swt2_weakexp1p0_ppfix.i \
