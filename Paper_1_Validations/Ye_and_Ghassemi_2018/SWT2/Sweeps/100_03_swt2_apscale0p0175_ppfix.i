# =============================================================================
# 100_03 REFINEMENT PROBE -- SW-T2
# Parent: 99_04_swt2_apscale0p0170_ppfix.i
# One hydraulic axis only: aperture_scale 0.0170 -> 0.0175. A stagewise linear
# response fit to 0.0165/0.0170 predicts the flow-error minimum near 0.01765 and
# mean nRMSE near 2.14%. Mechanical/contact properties remain unchanged.
# =============================================================================
# =============================================================================
...
aperture_scale = 0.0175 # 100_03: lower refinement bracket around fitted optimum
...
checkpoint_file_base = results_checkpoint_hpc_rorqual/100_03_swt2_apscale0p0175_ppfix_hpc
