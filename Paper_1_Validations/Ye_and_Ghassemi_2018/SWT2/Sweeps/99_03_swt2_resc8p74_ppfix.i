# =============================================================================
# 99_03 CONTROLLED CALIBRATION PROBE -- SW-T2
# Parent: 93_03_swt2_final_theta30_resc9p71_ppfix.i
# One material axis only: residual cohesion 9.71 -> 8.74 MPa. This restores the
# slightly better-scoring 91_03 residual-strength bracket while retaining every
# 93-series reporting fix. Expected gain is small and must clear the noise floor.
# =============================================================================
# =============================================================================
...
exodus_file_base = results_exodus_hpc_rorqual/99_03_swt2_resc8p74_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/99_03_swt2_resc8p74_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/99_03_swt2_resc8p74_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    residual_cohesion = 8.74e6 # 99_03: lower residual-strength bracket; peak cohesion unchanged
    use_dilatancy = true
