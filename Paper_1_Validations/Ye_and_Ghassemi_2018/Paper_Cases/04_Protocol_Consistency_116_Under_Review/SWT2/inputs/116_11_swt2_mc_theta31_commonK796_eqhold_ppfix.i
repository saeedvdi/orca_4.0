################################################################################
# ACTIVE PROTOCOL-CONSISTENCY CASE: 116_11_swt2_mc_theta31_commonK796_eqhold_ppfix
# Generated by build_protocol_consistency_inputs.py; parent deck is unchanged.
# Model/specimen: MC / SWT2
...
bulk_sin_theta = 0.5150380749100542
bulk_cos_theta = 0.8571673007021123
axial_bc_penalty = 397096905411

axial_pres_initial = -7.80665867137563e-05
axial_pres_final = -0.000849160929373345
...
exodus_file_base = proposed_inputs/protocol_consistency_20260902/exodus/116_11_swt2_mc_theta31_commonK796_eqhold_ppfix
csv_file_base = proposed_inputs/protocol_consistency_20260902/csv/116_11_swt2_mc_theta31_commonK796_eqhold_ppfix
checkpoint_file_base = proposed_inputs/protocol_consistency_20260902/checkpoint/116_11_swt2_mc_theta31_commonK796_eqhold_ppfix
...
[Mesh]
  ...
  [source_in]
    ...
    coord = '-0.019260000 0.0 0.034295977'   # requested 6.0 mm sidewall target; closest mesh node is selected
  ...
  [source_out]
    type = ExtraNodesetGenerator
    input = source_in
    coord = '0.019260000 0.0 0.098404023'   # requested 6.0 mm sidewall target; closest mesh node is selected
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.0 60.0 130.0 480.0 565.0 995.0 1070.0 1360.0 1460.0 1755.0 1850.0 2145.0 2280.0 2500.0 2510.0 2910.0 2920.0 3320.0 3330.0 3730.0 3740.0 4140.0 4160.0 4560.0'
    y = '5e+06 5e+06 8e+06 8e+06 1.2e+07 1.2e+07 1.6e+07 1.6e+07 2e+07 2e+07 2.4e+07 2.4e+07 2.8e+07 2.8e+07 2.4e+07 2.4e+07 2e+07 2e+07 1.6e+07 1.6e+07 1.2e+07 1.2e+07 8e+06 8e+06'
  []
