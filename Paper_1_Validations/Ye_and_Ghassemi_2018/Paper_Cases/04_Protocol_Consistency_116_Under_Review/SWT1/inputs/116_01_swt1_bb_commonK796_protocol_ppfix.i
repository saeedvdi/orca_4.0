################################################################################
# ACTIVE PROTOCOL-CONSISTENCY CASE: 116_01_swt1_bb_commonK796_protocol_ppfix
# Generated by build_protocol_consistency_inputs.py; parent deck is unchanged.
# Model/specimen: BB / SWT1
# COMMON MACHINE SPRING: K_sys = 796 kN/mm and
# k_p = K_sys/A = 397096905411 Pa/m.
...
axial_bc_penalty = 397096905411

axial_pres_initial = -7.80665867137563e-05
axial_pres_final = -0.000748076382762073
...
exodus_file_base = proposed_inputs/protocol_consistency_20260902/exodus/116_01_swt1_bb_commonK796_protocol_ppfix
csv_file_base = proposed_inputs/protocol_consistency_20260902/csv/116_01_swt1_bb_commonK796_protocol_ppfix
checkpoint_file_base = proposed_inputs/protocol_consistency_20260902/checkpoint/116_01_swt1_bb_commonK796_protocol_ppfix
...
[Mesh]
  ...
  [source_in]
    ...
    coord = '-0.019260000 0.0 0.033577557'   # requested 6.0 mm sidewall target; closest mesh node is selected
  ...
  [source_out]
    type = ExtraNodesetGenerator
    input = source_in
    coord = '0.019260000 0.0 0.095222443'   # requested 6.0 mm sidewall target; closest mesh node is selected
