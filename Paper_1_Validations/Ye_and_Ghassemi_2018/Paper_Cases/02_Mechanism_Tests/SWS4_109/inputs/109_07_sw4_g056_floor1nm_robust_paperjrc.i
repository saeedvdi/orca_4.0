# ROBUSTNESS VARIANT of 109_05, 2026-09-04. Solver settings only, no physics.
# 109_05 fails at t = 1798.5 s with the step already cut to dtmin, identically
# at 6 h and 24 h wall time, so it is a convergence failure and not a queue
# limit. Nothing happens in the protocol there: the surviving g = 0.42 run
# passes the same instant smoothly, injection easing off peak and effective
# normal stress flat near 15 MPa. The difference is the doubled gouge, which
# puts more of the surface on the 1 nm aperture clamp; that clamp is not
# smooth, so Newton stalls on it.
#   nl_abs_tol 1e-6 -> 1e-5    nl_rel_tol 1e-6 -> 1e-5
#   nl_max_its   70 -> 120     l_max_its    50 -> 100     line_search l2 -> bt
#
# REBUILT AT THE MEASURED JRC, 2026-09-04
# doubled gouge amplitude, relaxed bound. Replaces the legacy ablation of the same design, whose deck
# was never kept and which therefore could not be moved off bb_jrc = 5.0.
# Built from 109_01_sw4_floor1nm_g028_paperjrc.i, changing only the listed parameters.
#
# REBASED ONTO THE MEASURED JRC, 2026-09-04
# Parent: 109_07_sw4_g056_floor1nm_robust_paperjrc.i, which was built from
# 93_07_sw4_final_theta30_jrc5_ppfix.i (bb_jrc = 5.0). This copy carries the
# measured SW-S4 roughness of the source experiment instead, with the residual
# friction angle moved with it exactly as in 89_01, so that the ablation branches
# from the same primary reconstruction the paper reports.
#   bb_jrc                     5.0   -> 1.19
#   bb_residual_friction_angle 22.72 -> 23.709
# Every other parameter is unchanged from the parent.
#
# ==============================================================================
# 109_01 -- SW-S4 calibrated gouge with a relaxed hydraulic-aperture floor
# Created 2026-09-01 from 93_07_sw4_final_theta30_jrc5_ppfix.i.
#
# PURPOSE
#   Isolate the effect of the calibrated 0.74 um lower aperture bound.
#   This is a diagnostic counterfactual, not a recalibrated validation case.
#
# CONTROLLED CHANGES FROM 93_07
#   min_hydraulic_aperture: 0.74e-6 -> 1.0e-9 m
#   output file bases: unique 109_01 names
#   mesh path made relative to Sweeps/; the mesh itself is unchanged
#
# UNCHANGED
#   slip_damage_scale = 0.28e-6 m; dilation_scale = 0.0117; all mechanical,
#   closure, roughness, pressure-coupling, mesh, time-step, and loading controls.
# ==============================================================================
# =============================================================================
...
# --- mesh / geometry ---
mesh_file = ../mesh/ye2018_sw_s4_theta30_size5_mesh.e # same mesh; standalone path from Sweeps/
...
bb_jrc = 1.19                        # measured value for SW-S4 # 90_08: see 90_07 header. Was 17.5.                        # DECK54_20: 17.0->17.5. Holds the PEAK envelope (onset 996 was a
...
bb_residual_friction_angle = 23.709 # 90_08: re-anchored. Was 7.5.     # DECK54_20 (LOCKTRIM): 8.5 -> 7.5 deg. 54_07 SCORECARD (2026-07-11):
...
slip_damage_scale = 0.56e-6          # DECK54_01: from 52_11 hydraulic gouge-damage calibration.
...
min_hydraulic_aperture = 1.0e-9      # 109_01 diagnostic: relax the calibrated 0.74 um floor
...
# --- output ---
exodus_file_base = results/results_exodus/109_07_sw4_g056_floor1nm_robust_paperjrc
csv_file_base    = results/results_csv/109_07_sw4_g056_floor1nm_robust_paperjrc
checkpoint_file_base = results/results_exodus/109_07_sw4_g056_floor1nm_robust_paperjrc
