#!/bin/bash
#SBATCH --job-name=109_07_sw4_g056_floor1nm_robust_paperjrc
#SBATCH --account=def-biaoli66
#SBATCH --time=24:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=32
#SBATCH --mem=16G
#SBATCH --output=109_07_sw4_g056_floor1nm_robust_paperjrc_%j.out
#SBATCH --error=109_07_sw4_g056_floor1nm_robust_paperjrc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 109_07_sw4_g056_floor1nm_robust_paperjrc.i
