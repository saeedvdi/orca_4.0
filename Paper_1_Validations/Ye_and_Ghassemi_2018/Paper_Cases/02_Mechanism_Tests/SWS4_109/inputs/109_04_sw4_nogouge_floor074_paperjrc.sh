#!/bin/bash
#SBATCH --job-name=109_04_sw4_nogouge_floor074_paperjrc
#SBATCH --account=def-biaoli66
#SBATCH --time=06:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=32
#SBATCH --mem=16G
#SBATCH --output=109_04_sw4_nogouge_floor074_paperjrc_%j.out
#SBATCH --error=109_04_sw4_nogouge_floor074_paperjrc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 109_04_sw4_nogouge_floor074_paperjrc.i
