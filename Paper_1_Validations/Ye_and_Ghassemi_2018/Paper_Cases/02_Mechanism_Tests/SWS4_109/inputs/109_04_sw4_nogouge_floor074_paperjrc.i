...
# no gouge loss, calibrated 0.74 um bound. Replaces the legacy ablation of the same design, whose deck
...
# Parent: 109_04_sw4_nogouge_floor074_paperjrc.i, which was built from
...
slip_damage_scale = 0.0e-6          # DECK54_01: from 52_11 hydraulic gouge-damage calibration.
...
min_hydraulic_aperture = 0.74e-6      # 109_01 diagnostic: relax the calibrated 0.74 um floor
...
# --- output ---
exodus_file_base = results/results_exodus/109_04_sw4_nogouge_floor074_paperjrc
csv_file_base    = results/results_csv/109_04_sw4_nogouge_floor074_paperjrc
checkpoint_file_base = results/results_exodus/109_04_sw4_nogouge_floor074_paperjrc
