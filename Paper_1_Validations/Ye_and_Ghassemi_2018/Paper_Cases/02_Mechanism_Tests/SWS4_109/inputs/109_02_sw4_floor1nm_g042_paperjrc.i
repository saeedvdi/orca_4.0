...
# Parent: 109_02_sw4_floor1nm_g042_paperjrc.i, which was built from
...
#
# ==============================================================================
# 109_02 -- SW-S4 intermediate gouge loss with a relaxed aperture floor
# Created 2026-09-01 from 93_07_sw4_final_theta30_jrc5_ppfix.i.
#
# PURPOSE
#   Bracket the transition from retained enhancement to net permeability loss
#   between the calibrated 0.28 um and tested 0.56 um gouge-loss amplitudes.
#   This is a diagnostic counterfactual, not a recalibrated validation case.
#
# CONTROLLED CHANGES FROM 93_07
#   slip_damage_scale: 0.28e-6 -> 0.42e-6 m
#   min_hydraulic_aperture: 0.74e-6 -> 1.0e-9 m
#   output file bases: unique 109_02 names
#   mesh path made relative to Sweeps/; the mesh itself is unchanged
#
# UNCHANGED
#   dilation_scale = 0.0117; all mechanical, closure, roughness,
...
slip_damage_scale = 0.42e-6          # 109_02 diagnostic: midpoint between 0.28 and 0.56 um amplitudes
...
min_hydraulic_aperture = 1.0e-9      # 109_02 diagnostic: relax the calibrated 0.74 um floor
