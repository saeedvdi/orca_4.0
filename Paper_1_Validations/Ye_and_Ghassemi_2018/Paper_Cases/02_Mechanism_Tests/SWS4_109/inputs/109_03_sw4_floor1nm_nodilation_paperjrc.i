...
# Parent: 109_03_sw4_floor1nm_nodilation_paperjrc.i, which was built from
...
#
# ==============================================================================
# 109_03 -- SW-S4 no-dilation ablation with a relaxed aperture floor
# Created 2026-09-01 from 93_07_sw4_final_theta30_jrc5_ppfix.i.
#
# PURPOSE
#   Resolve the unconstrained no-dilation response. The earlier no-dilation
#   calculation ended with every interface element on the 0.74 um parent floor.
#   This is a diagnostic counterfactual, not a recalibrated validation case.
#
# CONTROLLED CHANGES FROM 93_07
#   dilation_scale: 0.0117 -> 0.0
#   min_hydraulic_aperture: 0.74e-6 -> 1.0e-9 m
#   output file bases: unique 109_03 names
#   mesh path made relative to Sweeps/; the mesh itself is unchanged
#
# UNCHANGED
#   slip_damage_scale = 0.28e-6 m; all mechanical, closure, roughness,
#   pressure-coupling, mesh, time-step, and loading controls.
# ==============================================================================
# =============================================================================
...
dilation_scale = 0.0                 # 109_03 diagnostic: remove retained hydraulic dilation
...
min_hydraulic_aperture = 1.0e-9      # 109_03 diagnostic: expose the unconstrained no-dilation response
...
# --- output ---
exodus_file_base = /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Examples/YeGhasemmi2018/SWS4/proposed_inputs/results/results_exodus/109_03_sw4_floor1nm_nodilation_paperjrc
csv_file_base    = /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Examples/YeGhasemmi2018/SWS4/proposed_inputs/results/results_csv/109_03_sw4_floor1nm_nodilation_paperjrc
checkpoint_file_base = /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Examples/YeGhasemmi2018/SWS4/proposed_inputs/results/results_exodus/109_03_sw4_floor1nm_nodilation_paperjrc
