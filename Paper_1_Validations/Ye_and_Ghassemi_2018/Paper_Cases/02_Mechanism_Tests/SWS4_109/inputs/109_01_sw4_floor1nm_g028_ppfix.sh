...
#SBATCH --ntasks=32
#SBATCH --mem=16G                   
#SBATCH --output=109_01_sw4_floor1nm_g028_ppfix_%j.out    
#SBATCH --error=109_01_sw4_floor1nm_g028_ppfix_%j.err     
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 109_01_sw4_floor1nm_g028_ppfix.i