#!/bin/bash
#SBATCH --job-name=109_03_sw4_floor1nm_nodilation_paperjrc
#SBATCH --account=def-biaoli66
#SBATCH --time=06:00:00
#SBATCH --nodes=1
#SBATCH --ntasks=32
#SBATCH --mem=16G
#SBATCH --output=109_03_sw4_floor1nm_nodilation_paperjrc_%j.out
#SBATCH --error=109_03_sw4_floor1nm_nodilation_paperjrc_%j.err
