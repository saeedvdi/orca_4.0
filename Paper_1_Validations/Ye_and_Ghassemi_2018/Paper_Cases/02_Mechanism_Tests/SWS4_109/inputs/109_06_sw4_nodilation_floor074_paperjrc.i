...
# no hydraulic dilation, calibrated 0.74 um bound. Replaces the legacy ablation of the same design, whose deck
# was never kept and which therefore could not be moved off bb_jrc = 5.0.
# Built from 109_03_sw4_floor1nm_nodilation_paperjrc.i, changing only the listed parameters.
#
# REBASED ONTO THE MEASURED JRC, 2026-09-04
# Parent: 109_06_sw4_nodilation_floor074_paperjrc.i, which was built from
...
min_hydraulic_aperture = 0.74e-6      # 109_03 diagnostic: expose the unconstrained no-dilation response
...
# --- output ---
exodus_file_base = results/results_exodus/109_06_sw4_nodilation_floor074_paperjrc
csv_file_base    = results/results_csv/109_06_sw4_nodilation_floor074_paperjrc
checkpoint_file_base = results/results_exodus/109_06_sw4_nodilation_floor074_paperjrc
