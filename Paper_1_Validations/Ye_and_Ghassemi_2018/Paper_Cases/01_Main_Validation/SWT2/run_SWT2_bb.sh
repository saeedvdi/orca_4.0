...
#SBATCH --chdir=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Paper_1_Validations/Ye_and_Ghassemi_2018/Paper_Cases/01_Main_Validation/SWT2/BB
...
#SBATCH --mem=32G
#SBATCH --output=logs/SWT2_OrcaBartonBandisContactTractionFastADHardening_%j.out
#SBATCH --error=logs/SWT2_OrcaBartonBandisContactTractionFastADHardening_%j.err

set -euo pipefail

PROJECT_ROOT=${ORCA_ROOT:-/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0}
CASE_DIR=${PROJECT_ROOT}/Paper_1_Validations/Ye_and_Ghassemi_2018/Paper_Cases/01_Main_Validation/SWT2/BB
cd "${CASE_DIR}"
