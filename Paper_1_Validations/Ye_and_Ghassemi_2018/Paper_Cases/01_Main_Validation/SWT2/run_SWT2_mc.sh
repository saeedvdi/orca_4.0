...
#SBATCH --job-name=mc_swt2
#SBATCH --chdir=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Paper_1_Validations/Ye_and_Ghassemi_2018/Paper_Cases/01_Main_Validation/SWT2/MC
...
CASE_DIR=${PROJECT_ROOT}/Paper_1_Validations/Ye_and_Ghassemi_2018/Paper_Cases/01_Main_Validation/SWT2/MC
cd "${CASE_DIR}"
unset SLURM_MEM_PER_NODE SLURM_MEM_PER_CPU SLURM_MEM_PER_GPU
mkdir -p logs

# Paper's selected MC member for SWT2 is 'pb04' (array index 4); that is
...
OUTDIR=results/${STEM}
mkdir -p "${OUTDIR}" logs
echo "deck : ${CASE_DIR}/SWT2_OrcaMohrCoulombContactTraction.i  (member ${LABELS[$IDX]})"
srun --mpi=pmi2 -n 32 "${PROJECT_ROOT}/orca-opt" -i "SWT2_OrcaMohrCoulombContactTraction.i" \
