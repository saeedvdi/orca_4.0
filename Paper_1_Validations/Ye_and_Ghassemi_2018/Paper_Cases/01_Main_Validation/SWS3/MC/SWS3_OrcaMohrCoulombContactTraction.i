...
#
# Historical construction: 94_05 was built from the 93-series BBFast sibling by
# replacing [czm_contact]. This renamed center retains that MC shear law and the
# BBFast-shared bulk, hydraulic, dilation, and numerical settings. The comparison
# isolates the shear law as closely as the two formulations allow; BBFast's
# explicit normal-unload retention has no MC counterpart.
#
...
# --- output ---
exodus_file_base = results_exodus/SWS3_OrcaMohrCoulombContactTraction
csv_file_base    = results_csv/SWS3_OrcaMohrCoulombContactTraction
checkpoint_file_base = results_checkpoint/SWS3_OrcaMohrCoulombContactTraction
