...
#SBATCH --job-name=bb_sws3
#SBATCH --chdir=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Paper_1_Validations/Ye_and_Ghassemi_2018/Paper_Cases/01_Main_Validation/SWS3/BB
...
#SBATCH --mem=32G
#SBATCH --output=logs/SWS3_OrcaBartonBandisContactTractionFastADHardening_%j.out
#SBATCH --error=logs/SWS3_OrcaBartonBandisContactTractionFastADHardening_%j.err

set -euo pipefail

PROJECT_ROOT=${ORCA_ROOT:-/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0}
CASE_DIR=${PROJECT_ROOT}/Paper_1_Validations/Ye_and_Ghassemi_2018/Paper_Cases/01_Main_Validation/SWS3/BB
cd "${CASE_DIR}"
unset SLURM_MEM_PER_NODE SLURM_MEM_PER_CPU SLURM_MEM_PER_GPU
mkdir -p logs

STEM=SWS3_OrcaBartonBandisContactTractionFastADHardening
