...
#SBATCH --job-name=bbfast_swt1_exodus
...
#SBATCH --mem=32G
#SBATCH --output=logs/107_01_swt1_coh27p2_apscale0p01512_ppfix_%j.out
#SBATCH --error=logs/107_01_swt1_coh27p2_apscale0p01512_ppfix_%j.err
