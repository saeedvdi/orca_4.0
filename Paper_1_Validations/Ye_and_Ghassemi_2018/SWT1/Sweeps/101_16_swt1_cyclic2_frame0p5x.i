...
axial_bc_penalty = 2.0615e+11    # 101: frame bracket arm: k_machine x 0.5

axial_pres_initial = -0.0001503759398    # 101: rescaled by 1/0.5 so the commanded stress is unchanged
axial_pres_final = -0.001462427777    # 101: rescaled by 1/0.5 so the commanded stress is unchanged
...
exodus_file_base = results_exodus_hpc_rorqual/101_16_swt1_cyclic2_frame0p5x_hpc
csv_file_base    = results_csv_hpc_rorqual/101_16_swt1_cyclic2_frame0p5x_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_16_swt1_cyclic2_frame0p5x_hpc
...
[Functions]
  ...
  # ========================================================================
  # 101-SERIES DISCUSSION DECK -- frame bracket, 2x SOFTER
  # 101_16_swt1_cyclic2_frame0p5x   parent: 93_01_swt1_final_c26p9_resc9p19_ppfix
  #
  ...
  #
  # THIS ARM: axial_bc_penalty x 0.5 (2x SOFTER).  Commanded stress unchanged.
  #
  # Ramp rate R = 14.0415 kPa/s, this specimen's own rate, measured from
  # its digitized schedule (5.00 -> 28.00 MPa in 1640.0 s).  The model
  ...
  #
  # Peaks (MPa): 28.00, 28.00;  floor 8.00 MPa;  every peak and floor held 200 s.
  #
  ...
  #     cycle 1 peak          hold  t =    1740.0 s
  #     cycle 1 floor         hold  t =    3364.3 s
  #     cycle 2 peak          hold  t =    4988.7 s
  #     cycle 2 floor         hold  t =    6613.0 s
  #     final ambient         hold  t =    7026.7 s
  # ========================================================================
  [injection_pressure]
    type = PiecewiseLinear
    x = '0.0000 2.0000 1640.0000 1840.0000 3264.3478 3464.3478 4888.6957 5088.6957 6513.0435 6713.0435 6926.6957 7126.6957'
    y = '5e+06 5e+06 2.8e+07 2.8e+07 8e+06 8e+06 2.8e+07 2.8e+07 8e+06 8e+06 5e+06 5e+06'
  []
...
[Outputs]
  ...
  [exodus]
    ...
    time_step_interval = 50   # 101: these runs are 10-21 ks of simulated time; nothing reads Exodus for them
  []
  [chk]
    type = Checkpoint
