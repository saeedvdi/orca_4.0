# =============================================================================
# 107_03 SWT1 EVENT-TIMING PROBE -- peak cohesion 27.80 MPa
...
# physics change: 26.88 -> 27.80 MPa.  The accepted hydraulic aperture scale
...
# without being updated. THIS DECK RUNS c = 27.80 MPa, c_res = 9.19 MPa. The refit fixes the parameterisation; the offset from it is calibrated, not derived.
#
...
exodus_file_base = results_exodus_local/107_03_swt1_coh27p8_apscale0p01512_ppfix
csv_file_base    = results_csv_local/107_03_swt1_coh27p8_apscale0p01512_ppfix
checkpoint_file_base = results_checkpoint_local/107_03_swt1_coh27p8_apscale0p01512_ppfix
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 2.780e7 # 107_03: peak-strength timing probe; parent 106_01 used 2.688e7.
