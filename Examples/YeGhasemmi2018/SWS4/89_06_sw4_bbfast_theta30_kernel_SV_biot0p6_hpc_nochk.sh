...
#SBATCH --job-name=89_06_sw4_bbfast_theta30_kernel_SV_biot0p6_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/89_06_sw4_bbfast_theta30_kernel_SV_biot0p6_hpc_%j.out
#SBATCH --error=logs/89_06_sw4_bbfast_theta30_kernel_SV_biot0p6_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 89_06_sw4_bbfast_theta30_kernel_SV_biot0p6.i \
