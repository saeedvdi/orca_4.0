...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/101_12_sw4_shutin_nohold_hpc
csv_file_base    = results_csv_hpc_rorqual/101_12_sw4_shutin_nohold_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_12_sw4_shutin_nohold_hpc
...
[Functions]
  ...
  # 101_12_sw4_shutin_nohold   parent: 93_07_sw4_final_theta30_jrc5_ppfix
  #
  ...
  # Shut-in instant t = 2518.7 s;  3000 s of observation after it.
  #
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<800, 5e+06, if(t<2518.7, 5e+06+(2.796e+07-5e+06)*(t-800)/1718.7, if(t<2518.7, 2.796e+07, 5e+06+(2.796e+07-5e+06)*exp(-(t-2518.7)/150))))'
  []
