# =============================================================================
# 99_08 CONTROLLED CALIBRATION PROBE -- SW-S4
# Parent: 93_07_sw4_final_theta30_jrc5_ppfix.i
# One material axis only: tangential viscosity 3.5e12 -> 3.0e12 Pa.s/m.
# Hypothesis: reduce transient shear overstress and permit earlier ramp slip.
# The weakening law and all hydraulic properties are unchanged.
# =============================================================================
# =============================================================================
...
tangential_viscosity = 3.0e12        # 99_08: narrow rate-overstress reduction
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/99_08_sw4_eta3p0e12_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/99_08_sw4_eta3p0e12_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/99_08_sw4_eta3p0e12_ppfix_hpc
