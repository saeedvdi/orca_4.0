...
#SBATCH --mem=32G
#SBATCH --output=logs/68_03_sw4_bbfast_tail6p50_eta3p25_m0_%j.out
#SBATCH --error=logs/68_03_sw4_bbfast_tail6p50_eta3p25_m0_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 68_03_sw4_bbfast_tail6p50_eta3p25_m0.i
