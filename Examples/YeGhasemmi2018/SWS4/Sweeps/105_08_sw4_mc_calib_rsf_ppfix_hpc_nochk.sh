...
#SBATCH --job-name=105_08_sw4_mc_calib_rsf_ppfix_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/105_08_sw4_mc_calib_rsf_ppfix_hpc_%j.out
#SBATCH --error=logs/105_08_sw4_mc_calib_rsf_ppfix_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 105_08_sw4_mc_calib_rsf_ppfix.i \
