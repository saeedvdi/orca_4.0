...
# GENERATED 2026-08-15 from 68_02_sw4_bbfast_tail6p75_eta3p25_m0_cyclic.i -- do not hand-edit; regenerate instead.
#
...
#      in 68_02_sw4_bbfast_tail6p75_eta3p25_m0_cyclic.i.
#   3. Output file bases repointed to this deck's own name.
#
# The parent deck 68_02_sw4_bbfast_tail6p75_eta3p25_m0_cyclic.i is left untouched as the reference configuration.
# ==============================================================================
# ===============================================================================
...
# --- output ---
exodus_file_base = results_exodus/68_02_sw4_bbfast_tail6p75_eta3p25_m0_cyclic_kernel_SV
csv_file_base    = results_csv/68_02_sw4_bbfast_tail6p75_eta3p25_m0_cyclic_kernel_SV
checkpoint_file_base = results_checkpoint/68_02_sw4_bbfast_tail6p75_eta3p25_m0_cyclic_kernel_SV
...
[Functions]
  ...
  # orca_3.0 v4 deck 10_SWS4_BBFast_mesh5_cyclic.i (see that deck's header for the full
  # rationale). Hydroshearing-analog schedule: 4 pressure cycles of increasing peak (15/20/24/
  # 28 MPa), each held 100s then bled back to an 8 MPa intermediate floor for 100s before the
  # next ramp, ending with a final bleed to ambient (5 MPa). Isolates how the aperture-law choice
  # (additive here; see the _bakhtar_cyclic sibling) affects permeability/injectivity evolution
  # across repeated load-unload cycles -- the injection schedule is the ONLY thing that differs
  # from this deck's own single-cycle parent.
  [injection_pressure]
    type = PiecewiseLinear
