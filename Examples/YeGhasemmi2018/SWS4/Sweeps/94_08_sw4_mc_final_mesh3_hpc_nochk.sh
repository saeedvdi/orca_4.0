...
#SBATCH --job-name=94_08_sw4_mc_final_mesh3_hpc
...
#SBATCH --mem=128G
#SBATCH --output=logs/94_08_sw4_mc_final_mesh3_hpc_%j.out
#SBATCH --error=logs/94_08_sw4_mc_final_mesh3_hpc_%j.err
...
srun --mpi=pmi2 -n 128 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 94_08_sw4_mc_final_mesh3.i \
