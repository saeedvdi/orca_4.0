# =============================================================================
# 106_11 CORNER -- SW-S4  (106_08 strength level + 106_10 hydraulic closure)
# Parent: 93_07_sw4_final_theta30_jrc5_ppfix.i
#
# Carries BOTH single-axis changes:
#   106_08  bb_residual_friction_angle 22.72 -> 21.60 deg   (targets tau, d_s, d_n)
#   106_10  V_h 1.8277 um, K_h 6.1366e12 Pa/m, p 3.28       (targets Q)
#
# These two are genuinely orthogonal in a way the SW-T2 pair is not: the strength
# arm moves the mechanical state and the aperture arm only changes how a_h is read
# off it, and SW-S4's aperture law has no term that feeds back into the envelope.
# If both singles behave, this is the expected best SW-S4 deck: predicted mean
# 6.139 -> near 5.0 %, with the tau channel (10.103, the campaign's single worst)
# carrying most of the gain.  Still, read it only after 106_08 and 106_10 score.
# =============================================================================
# =============================================================================
...
# =============================================================================
# =============================================================================================
# 106_11_sw4_phir21p60_hydbb_ppfix
#
...
bb_residual_friction_angle = 21.60 # 106_11: from 106_08. Was 22.72.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/106_11_sw4_phir21p60_hydbb_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/106_11_sw4_phir21p60_hydbb_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/106_11_sw4_phir21p60_hydbb_ppfix_hpc
