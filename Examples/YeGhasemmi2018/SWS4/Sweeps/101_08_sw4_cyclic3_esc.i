...
relax_t0 = 100    # 101: frame term retimed to complete before injection starts
relax_dur = 400    # 101: frame term retimed to complete before injection starts
poro_du = 2.9e-6    # CONTROL: legacy fitted poroelastic piston compensation
poro_dur = 300    # 101: frame term retimed to complete before injection starts
...
side_unload_t0 = 100    # 101: frame term retimed to complete before injection starts
side_unload_dur = 600    # 101: frame term retimed to complete before injection starts
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/101_08_sw4_cyclic3_esc_hpc
csv_file_base    = results_csv_hpc_rorqual/101_08_sw4_cyclic3_esc_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_08_sw4_cyclic3_esc_hpc
...
[Functions]
  ...
  # 101_08_sw4_cyclic3_esc   parent: 93_07_sw4_final_theta30_jrc5_ppfix
  #
  ...
  #
  # Ramp rate R = 13.3589 kPa/s, this specimen's own rate, measured from
  # its digitized schedule (5.00 -> 27.96 MPa in 1720.7 s).  The model
  ...
  #
  # Peaks (MPa): 23.96, 25.96, 27.96;  floor 8.00 MPa;  every peak and floor held 200 s.
  #
  # Injection starts at t = 800 s, not t = 2 s.  SW-S4's fitted
  ...
  #     cycle 1 peak          hold  t =    2319.3 s
  #     cycle 1 floor         hold  t =    3714.0 s
  #     cycle 2 peak          hold  t =    5258.4 s
  #     cycle 2 floor         hold  t =    6802.8 s
  #     cycle 3 peak          hold  t =    8496.9 s
  #     cycle 3 floor         hold  t =   10191.1 s
  #     final ambient         hold  t =   10615.6 s
  # ========================================================================
  [injection_pressure]
    type = PiecewiseLinear
    x = '0.0000 800.0000 2219.2749 2419.2749 3613.9810 3813.9810 5158.3997 5358.3997 6702.8183 6902.8183 8396.9495 8596.9495 10091.0807 10291.0807 10515.6495 10715.6495'
    y = '5e+06 5e+06 2.396e+07 2.396e+07 8e+06 8e+06 2.596e+07 2.596e+07 8e+06 8e+06 2.796e+07 2.796e+07 8e+06 8e+06 5e+06 5e+06'
  []
