...
# GENERATED 2026-08-15 from 68_03_sw4_bbfast_tail6p50_eta3p25_m0.i -- do not hand-edit; regenerate instead.
#
...
#      in 68_03_sw4_bbfast_tail6p50_eta3p25_m0.i.
#   3. Output file bases repointed to this deck's own name.
#
# The parent deck 68_03_sw4_bbfast_tail6p50_eta3p25_m0.i is left untouched as the reference configuration.
# ==============================================================================
# ===============================================================================
# SW4 68 targeted residual sweep: 68_03_sw4_bbfast_tail6p50_eta3p25_m0
# Parent: completed 67_01_sw4_bbfast_eta3p5_Dc74p5_tail6p75_m0.
# Controlled point: eta=3.25e12 Pa.s/m, Dc=74.5um, tail=6.50deg.
# This completes the 2x2 eta/tail bracket; all other physics and outputs are fixed.
# ===============================================================================
# ===============================================================================
# SW4 final local coarse-M0 refinement: 68_03_sw4_bbfast_tail6p50_eta3p25_m0
...
# ===============================================================================
# ==============================================================================
# SW4 64-series staged refinement: 68_03_sw4_bbfast_tail6p50_eta3p25_m0
...
# ==============================================================================
######################################################################################
# CONTROLLED SW-S4 OBSERVATION/INPUT BRACKET -- 68_03_sw4_bbfast_tail6p50_eta3p25_m0
...
# --- output ---
exodus_file_base = results_exodus/68_03_sw4_bbfast_tail6p50_eta3p25_m0_kernel_SV
csv_file_base    = results_csv/68_03_sw4_bbfast_tail6p50_eta3p25_m0_kernel_SV
checkpoint_file_base = results_checkpoint/68_03_sw4_bbfast_tail6p50_eta3p25_m0_kernel_SV
