# =============================================================================================
# 90_07_sw4_bbfast_theta30_jrc9_kernel_SV_biot0p6
#
# 90-SERIES: fix the ONSET, keep the RESIDUALS.  Back-analysis 2026-08-17.
# Parent: 89_06_sw4_bbfast_theta30_kernel_SV_biot0p6.i -- 10.5% mean normalized RMSE -- the BEST SW-S4 case -- event 50-73 s late, residual shear stress 2.82 MPa against 2.25 validated
#
...
#
# SW-S4 SPECIFIC.  89_01 and 89_06 are a clean 3-parameter controlled pair on the same theta30
# mesh and the same schedule: (JRC, JCS, phi_r) = (1.19, 150 MPa, 23.709) vs (17.5, 300 MPa,
# 7.5).  They straddle the target on BOTH axes:
#     onset crossing   89_01 14-15 MPa (early)   89_06 17-18 MPa (50-73 s late)
#     residual shear   89_01 1.75 MPa (low)      89_06 2.82 MPa (high)   validation 2.25
# so SW-S4 wants a case BETWEEN them, and the residual difference is a JRC effect carried
# through roughness_state_residual = 0.10 (0.10*17.5 = 1.75 effective JRC still acting at the
# residual, against 0.10*1.19 = 0.12).
#
# This arm and 90_08 hold the PEAK envelope fixed at 89_06's value at the crossing stress
# (sigma'_n ~= 24 MPa, phi_eff = 26.70 deg) and vary ONLY the slope and the residual, by
# re-anchoring phi_r whenever JRC moves.  That isolates the one thing 89_06 gets wrong.
#
# THIS DECK: jrc 17.5 -> 9.0, jcs 3.0e8 -> 1.5e8 (the paper's UCS), phi_r 7.5 -> 19.54 deg.
# phi_r is not free: it is solved from phi_r + 9*log10(150/24) = 26.70, which is 89_06's own
# peak phi_eff at the crossing stress.  Interpolating the residual shear linearly in JRC
# between 89_01 (1.75 MPa) and 89_06 (2.82 MPa) puts the validated 2.25 MPa at JRC ~= 8.8.
#
# PREDICTION: crossing moves from 17-18 MPa to 16-17 (a small DELAYING correction is not wanted here -- 89_06 is already slightly late, so the target is to hold the crossing while dropping the residual) MPa.  NOTE the SW-S4 postprocessor fix of 2026-08-17 is in this deck: injection_pressure_pp and
# pp_outlet_pp are now nodeset averages, not stale PointValues 5.86 mm and 0.89 mm off-node.
# =============================================================================================
# ==============================================================================
# 90_07_sw4_bbfast_theta30_jrc9_kernel_SV_biot0p6
...
bb_jrc = 9.0 # 90_07: see header. Was 17.5.                        # DECK54_20: 17.0->17.5. Holds the PEAK envelope (onset 996 was a
...
bb_jcs = 1.5e8 # 90_07: paper Sec 2.1 UCS. Was 3.0e8.                       # Pa; intact-granite wall strength
bb_residual_friction_angle = 19.54 # 90_07: re-anchored, see header. Was 7.5.     # DECK54_20 (LOCKTRIM): 8.5 -> 7.5 deg. 54_07 SCORECARD (2026-07-11):
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/90_07_sw4_bbfast_theta30_jrc9_kernel_SV_biot0p6_hpc
csv_file_base    = results_csv_hpc_rorqual/90_07_sw4_bbfast_theta30_jrc9_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/90_07_sw4_bbfast_theta30_jrc9_kernel_SV_biot0p6_hpc
