...
#SBATCH --job-name=104_01_sw4_shutin_nogouge_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/104_01_sw4_shutin_nogouge_hpc_%j.out
#SBATCH --error=logs/104_01_sw4_shutin_nogouge_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 104_01_sw4_shutin_nogouge.i \
