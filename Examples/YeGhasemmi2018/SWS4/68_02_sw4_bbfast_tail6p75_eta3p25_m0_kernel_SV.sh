...
#SBATCH --mem=64G
#SBATCH --output=68_02_sw4_bbfast_tail6p75_eta3p25_m0_%j.out
#SBATCH --error=68_02_sw4_bbfast_tail6p75_eta3p25_m0_%j.err
...
case_stem=68_02_sw4_bbfast_tail6p75_eta3p25_m0
