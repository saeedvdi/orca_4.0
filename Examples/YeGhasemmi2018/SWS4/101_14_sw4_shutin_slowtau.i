...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/101_14_sw4_shutin_slowtau_hpc
csv_file_base    = results_csv_hpc_rorqual/101_14_sw4_shutin_slowtau_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_14_sw4_shutin_slowtau_hpc
...
[Functions]
  ...
  # 101_14_sw4_shutin_slowtau   parent: 93_07_sw4_final_theta30_jrc5_ppfix
  #
  ...
  #
  # Ramp 5.00 -> 27.96 MPa over t = 800 .. 2518.7 s at this
  # specimen's own rate, hold 200 s, then shut in: the injection node relaxes
  # exponentially toward ambient with tau = 1500 s.
  # Shut-in instant t = 2718.7 s;  6000 s of observation after it.
  #
  # Injection starts at t = 800 s because SW-S4's fitted frame terms are
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<800, 5e+06, if(t<2518.7, 5e+06+(2.796e+07-5e+06)*(t-800)/1718.7, if(t<2718.7, 2.796e+07, 5e+06+(2.796e+07-5e+06)*exp(-(t-2718.7)/1500))))'
  []
