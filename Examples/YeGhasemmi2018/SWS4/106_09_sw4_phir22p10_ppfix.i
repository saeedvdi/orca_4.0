# =============================================================================
# 106_09 STRENGTH-LEVEL PROBE (HALF STEP) -- SW-S4
# Parent: 93_07_sw4_final_theta30_jrc5_ppfix.i  (mean nRMSE 6.139 %)
#
# ONE LINE CHANGES: bb_residual_friction_angle 22.72 -> 22.10 deg.
#
...
#
# This is the interior point of the bracket.  It recovers about 57 % of the
# stage-4 correction while keeping a +0.508 MPa margin at the model's stage 3,
# more than twice 106_08's.  Run both: two points plus the parent give the
# curvature of the response, which the 105 series went without and paid for.
...
bb_residual_friction_angle = 22.10 # 106_09: half-step level correction, see header. Was 22.72.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/106_09_sw4_phir22p10_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/106_09_sw4_phir22p10_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/106_09_sw4_phir22p10_ppfix_hpc
