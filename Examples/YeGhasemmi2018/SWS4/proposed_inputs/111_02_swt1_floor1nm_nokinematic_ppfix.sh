...
#SBATCH --ntasks=32
#SBATCH --mem=16G                   
#SBATCH --output=111_02_swt1_floor1nm_nokinematic_ppfix_%j.out    
#SBATCH --error=111_02_swt1_floor1nm_nokinematic_ppfix_%j.err     
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 111_02_swt1_floor1nm_nokinematic_ppfix.i