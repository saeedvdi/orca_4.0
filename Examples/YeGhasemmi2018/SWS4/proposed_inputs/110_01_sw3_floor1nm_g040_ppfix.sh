...
#SBATCH --mem=16G
#SBATCH --output=proposed_inputs/paper_revision_20260901_sw3_followup/logs/110_01_sw3_floor1nm_g040_ppfix_%j.out
#SBATCH --error=proposed_inputs/paper_revision_20260901_sw3_followup/logs/110_01_sw3_floor1nm_g040_ppfix_%j.err
