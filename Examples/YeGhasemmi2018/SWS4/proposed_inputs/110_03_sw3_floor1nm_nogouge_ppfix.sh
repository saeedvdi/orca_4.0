...
#SBATCH --ntasks=32
#SBATCH --mem=16G                   
#SBATCH --output=110_03_sw3_floor1nm_nogouge_ppfix_%j.out    
#SBATCH --error=110_03_sw3_floor1nm_nogouge_ppfix_%j.err     
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 110_03_sw3_floor1nm_nogouge_ppfix.i