...
srun --mpi=pmi2 -n 32 "${PROJECT_ROOT}/orca-opt" \
  -i "${CASE_DIR}/proposed_inputs/110_03_sw3_floor1nm_nogouge_ppfix.i" \
  Outputs/chk/enable=false \
  "csv_file_base=${RESULTS_DIR}/results_csv/110_03_sw3_floor1nm_nogouge_ppfix" \
  "exodus_file_base=${RESULTS_DIR}/results_exodus/110_03_sw3_floor1nm_nogouge_ppfix"
