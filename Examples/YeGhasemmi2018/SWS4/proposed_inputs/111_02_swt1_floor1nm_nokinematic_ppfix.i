# =============================================================================
# 111_02 -- SW-T1 kinematic-aperture ablation with a relaxed lower bound
#
# Parent: 107_01_swt1_coh27p2_apscale0p01512_ppfix.i
# Controlled changes: min_hydraulic_aperture 1.5105e-6 -> 1.0e-9 m and
#                     aperture_scale 0.01512 -> 0.
# Purpose: isolate the hydraulic contribution of the mechanically persistent gap.
# Mechanical dilation remains active, so stress, slip, and geometric opening are
# still solved; only their mapped contribution to hydraulic aperture is removed.
# This is a diagnostic ablation, not a recalibrated validation case.
# =============================================================================
# =============================================================================
...
aperture_scale = 0.0      # 111_02 diagnostic: remove mapped kinematic opening
...
min_hydraulic_aperture = 1.0e-9  # 111_02 diagnostic: expose the unconstrained response
...
exodus_file_base = /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Examples/YeGhasemmi2018/SWS4/proposed_inputs/results/results_exodus/111_02_swt1_floor1nm_nokinematic_ppfix
csv_file_base    = /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Examples/YeGhasemmi2018/SWS4/proposed_inputs/results/results_csv/111_02_swt1_floor1nm_nokinematic_ppfix
checkpoint_file_base = /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/Examples/YeGhasemmi2018/SWS4/proposed_inputs/results/results_exodus/111_02_swt1_floor1nm_nokinematic_ppfix
