# ==============================================================================
# 89_01_sw4_bbfast_theta30_paperjrc_kernel_SV_biot0p6
...
#
# CONTROLLED AXIS: fracture angle AND joint constants (both audit corrections)
#
# 1. MESH  28.990 deg, 2.85 mm off centre  ->  30.000 deg, centred.
...
#
# STATUS: CORRECTION. Both changes replace an invented value with the paper's own. Re-gate axial_pres_final if the post-ramp tau moves more than 0.5 MPa: the 30 deg mesh raises tau by 2.1 % and the sigma_d part of sigma'_n by 6.0 % at the same axial load, both toward the data.
# ==============================================================================
# ==============================================================================
...
bb_jrc = 1.19                        # PAPER Table 1 (measured). Was 17.5, 14.7x the measured value.
...
bb_jcs = 1.5e8                       # PAPER Sec. 2.1 UCS. Was 3.0e8, 2x the measured value.
bb_residual_friction_angle = 23.709  # pins the envelope through Table 2's last stick stage (26.51 MPa, 12.14 MPa) at the measured JRC/JCS. Was 7.5, which no granite joint has.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/89_01_sw4_bbfast_theta30_paperjrc_kernel_SV_biot0p6_hpc
csv_file_base    = results_csv_hpc_rorqual/89_01_sw4_bbfast_theta30_paperjrc_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/89_01_sw4_bbfast_theta30_paperjrc_kernel_SV_biot0p6_hpc
