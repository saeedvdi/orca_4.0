# =============================================================================
# 95-SERIES -- RATE-AND-STATE FRICTION REPLACES THE PERZYNA VISCOSITY.  SW-S4 mesh 5
# Built from 93_07_sw4_final_theta30_jrc5_ppfix.i.  The Barton-Bandis envelope, the
...
#   regulariser.  It is not one: the kernel forms eta*V, so at SW-S4's
#   eta = 3.5e+12 Pa.s/m it is worth 0.03-3.5 MPa across the plausible slip-velocity
...
#
# THIS DECK
#   VELOCITY WEAKENING. a-b = -0.005, which permits stick-slip. The other half of the
#   bracket: if the SW-S4 staircase needs sharper bursts this is the direction, and
#   if it makes every specimen unstable the bracket has closed against b.
#
#   rsf_a = 0.01, rsf_b = 0.015
...
#
# CONTROL: 93_07_sw4_final_theta30_jrc5_ppfix.i is the 93-series deck this was built
...
tangential_viscosity = 0.0           # 95-SERIES: rate dependence now comes from rate-and-state, not Perzyna. Was 3.5e12 (66_03 "lower the transient shear pedestal") -- that fitted value implies a = 9.5e-3, see banner.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/95_16_sw4_rsf_a010_b015
csv_file_base    = results_csv_hpc_rorqual/95_16_sw4_rsf_a010_b015
checkpoint_file_base = results_checkpoint_hpc_rorqual/95_16_sw4_rsf_a010_b015
