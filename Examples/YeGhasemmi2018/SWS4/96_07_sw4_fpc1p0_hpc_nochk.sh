...
#SBATCH --job-name=96_07_sw4_fpc1p0_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/96_07_sw4_fpc1p0_hpc_%j.out
#SBATCH --error=logs/96_07_sw4_fpc1p0_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 96_07_sw4_fpc1p0.i \
    Outputs/chk/enable=false \
    csv_file_base=results_csv_hpc_rorqual/96_07_sw4_fpc1p0_hpc \
    exodus_file_base=results_exodus_hpc_rorqual/96_07_sw4_fpc1p0_hpc
