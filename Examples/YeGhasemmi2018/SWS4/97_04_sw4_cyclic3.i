...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/97_04_sw4_cyclic3_hpc
csv_file_base    = results_csv_hpc_rorqual/97_04_sw4_cyclic3_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/97_04_sw4_cyclic3_hpc
...
[Functions]
  ...
  #
  # Ramp rate R = 13.3589 kPa/s, taken from this specimen's own
  # schedule (5.00 -> 27.96 MPa in 1720.7 s), so the cyclic run
  # loads at the same rate as the run it is compared against.
  # Peak 27.96 MPa held 200 s; floor 8.00 MPa held 200 s.
  #
  ...
  #     cycle 1 peak  hold  t =    1820.7 s
  #     cycle 1 floor hold  t =    3514.8 s
  #     cycle 2 peak  hold  t =    5209.0 s
  #     cycle 2 floor hold  t =    6903.1 s
  #     cycle 3 peak  hold  t =    8597.2 s
  #     cycle 3 floor hold  t =   10291.4 s
  # ------------------------------------------------------------------------
  [injection_pressure]
    type = PiecewiseLinear
    x = '0.0000 2.0000 1720.7000 1920.7000 3414.8312 3614.8312 5108.9624 5308.9624 6803.0936 7003.0936 8497.2247 8697.2247 10191.3559 10391.3559 10615.9247 10815.9247'
