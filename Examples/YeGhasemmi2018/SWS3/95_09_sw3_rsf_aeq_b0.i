...
#   eta = 4e+11 Pa.s/m, sigma'_n = 23.42 MPa). b = 0 removes state evolution, so this
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/95_09_sw3_rsf_aeq_b0
csv_file_base    = results_csv_hpc_rorqual/95_09_sw3_rsf_aeq_b0
checkpoint_file_base = results_checkpoint_hpc_rorqual/95_09_sw3_rsf_aeq_b0
