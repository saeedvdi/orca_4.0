...
# GENERATED 2026-08-15 from 84_02_sw3_bbfast_postevent_retreat6p0um_m0_kernel_SV.i -- do not hand-edit; regenerate instead.
#
...
#
# The parent deck 84_02_sw3_bbfast_postevent_retreat6p0um_m0_kernel_SV.i is left untouched.
# ==============================================================================
######################################################################################
# 84_02_sw3_bbfast_postevent_retreat6p0um_m0
...
# Parameters: post-event axial actuator retreat=6.0um over t=2550-2850s
# Hypothesis: The measured axial series stiffness predicts a 2.7MPa q reduction and a 1.16MPa paper-shear reduction, close to the observed late BBFast residual.
# Decision rule: Keep only if late paper shear and normal stress improve without moving slip/dilation by more than 0.5/1.0um or degrading hydraulics.
...
# --- output ---
exodus_file_base = results_exodus/84_02_sw3_bbfast_postevent_retreat6p0um_m0_kernel_SV_mesh3
csv_file_base    = results_csv/84_02_sw3_bbfast_postevent_retreat6p0um_m0_kernel_SV_mesh3
checkpoint_file_base = results_checkpoint/84_02_sw3_bbfast_postevent_retreat6p0um_m0_kernel_SV_mesh3
...
[Functions]
  ...
  [axial_disp_ramp]
      ...
      expression = 'if(t<2.0,${axial_pres_initial},if(t<55.0,${axial_pres_initial}+(${axial_pres_final}-${axial_pres_initial})*(t-2.0)/53.0,if(t<2550.0,${axial_pres_final},if(t<2850.0,${axial_pres_final}+6e-06*(t-2550.0)/300.0,${axial_pres_final}+6e-06))))'
    []
