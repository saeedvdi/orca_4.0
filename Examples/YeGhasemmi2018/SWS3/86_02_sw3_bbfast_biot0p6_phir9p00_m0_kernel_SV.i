...
#
# THIS DECK: residual_friction_angle_degrees = 9.00
# =============================================================================
...
# --- output ---
exodus_file_base = results_exodus/86_02_sw3_bbfast_biot0p6_phir9p00_m0_kernel_SV
csv_file_base    = results_csv/86_02_sw3_bbfast_biot0p6_phir9p00_m0_kernel_SV
checkpoint_file_base = results_checkpoint/86_02_sw3_bbfast_biot0p6_phir9p00_m0_kernel_SV
...
[Materials]
  ...
  [czm_contact]
    ...
    jrc = 23.35
    jcs = 3.0e8
    residual_friction_angle_degrees = 9.00
    ...
    slip_weakening_residual_friction_angle_degrees = 9.00
