...
#SBATCH --job-name=98_03_sw3_shutin_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/98_03_sw3_shutin_hpc_%j.out
#SBATCH --error=logs/98_03_sw3_shutin_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 98_03_sw3_shutin.i \
