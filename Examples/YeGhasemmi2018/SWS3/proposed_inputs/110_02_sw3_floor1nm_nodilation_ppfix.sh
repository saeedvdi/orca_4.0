...
#SBATCH --mem=24G
#SBATCH --output=proposed_inputs/paper_revision_20260901_sw3_followup/logs/110_02_sw3_floor1nm_nodilation_ppfix_%j.out
#SBATCH --error=proposed_inputs/paper_revision_20260901_sw3_followup/logs/110_02_sw3_floor1nm_nodilation_ppfix_%j.err

set -euo pipefail

PROJECT_ROOT=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0
CASE_STEM=110_02_sw3_floor1nm_nodilation_ppfix
