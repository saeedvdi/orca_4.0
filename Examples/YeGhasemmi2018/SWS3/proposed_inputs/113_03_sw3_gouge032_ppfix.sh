...
#SBATCH --job-name=113_03_sw3_gouge032_ppfix
...
#SBATCH --mem=24G
#SBATCH --output=proposed_inputs/paper_compelling_20260902/logs/113_03_sw3_gouge032_ppfix_%j.out
#SBATCH --error=proposed_inputs/paper_compelling_20260902/logs/113_03_sw3_gouge032_ppfix_%j.err

set -euo pipefail

PROJECT_ROOT=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0
CASE_STEM=113_03_sw3_gouge032_ppfix
