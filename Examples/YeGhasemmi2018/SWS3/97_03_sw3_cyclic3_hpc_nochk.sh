...
#SBATCH --job-name=97_03_sw3_cyclic3_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/97_03_sw3_cyclic3_hpc_%j.out
#SBATCH --error=logs/97_03_sw3_cyclic3_hpc_%j.err
...
srun --mpi=pmi2 -n 16 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 97_03_sw3_cyclic3.i \
