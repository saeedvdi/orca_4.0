# =============================================================================
# 108_13 -- SWS3 -- closure creep tau_c = 1e5 s
#
...
#
# CHANGES FROM PARENT
#   1. end_time 4802 -> 1.0048e+06 s (the paper protocol is untouched up to 4802 s;
...
#   a_c_max = 0.3590 um = this run's own retained gain, a_h(T_p) - a_h0.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/108_13_sw3_creeptc1e5
csv_file_base    = results_csv_hpc_rorqual/108_13_sw3_creeptc1e5
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_13_sw3_creeptc1e5
...
[Materials]
  ...
  [czm_aperture]
    ...
    closure_creep_max_aperture = 3.59e-07
    closure_creep_time = 100000
    closure_creep_reference_stress = 32.1e6
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 1.0048e+06   # 108: protocol ends at 4802 s; the rest is the hold
  ...
  dtmax = 2000   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 4802 s
