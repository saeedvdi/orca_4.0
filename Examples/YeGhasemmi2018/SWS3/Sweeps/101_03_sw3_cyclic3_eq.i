...
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_03_sw3_cyclic3_eq_hpc
...
[Functions]
  ...
  # 101_03_sw3_cyclic3_eq   parent: 93_05_sw3_final_resc1p40_ppfix
  #
  ...
  #
  # Peaks (MPa): 28.57, 28.57, 28.57;  floor 8.00 MPa;  every peak and floor held 200 s.
  #
  ...
  #     final ambient         hold  t =   15692.7 s
  # ========================================================================
  [injection_pressure]
    type = PiecewiseLinear
