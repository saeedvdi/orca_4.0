# =============================================================================
# 108_05 -- SWS3 -- reconfinement to 3.5x sigma_3
#
# Parent: 100_06_sw3_resc1p30_unld0p00_ppfix.i  (unchanged except where listed below)
...
#
# CHANGES FROM PARENT
#   1. end_time 4802 -> 7502 s (the paper protocol is untouched up to 4802 s;
...
#      returns the parent's cap up to t = 4802 s. The calibrated window is stepped
...
#      t <= 4802 s and then steps 1.5 / 2.0 / 2.5 / 3.0 / 3.5 in 350 s holds.
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/108_05_sw3_reconf3p5x
csv_file_base    = results_csv_hpc_rorqual/108_05_sw3_reconf3p5x
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_05_sw3_reconf3p5x
...
[Functions]
  [reconfine_factor]
    ...
    x = '0 4802 5002 5152 5502 5652 6002 6152 6502 6652 7002 7152 7502'
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 7502   # 108: protocol ends at 4802 s; the rest is the hold
  ...
  dtmax = 2   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 4802 s
