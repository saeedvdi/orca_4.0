# =============================================================================================
# 90_05_sw3_bbfast_paperjrc_L123p4_cohes1p67_kernel_SV_biot0p6
#
# 90-SERIES: fix the ONSET, keep the RESIDUALS.  Back-analysis 2026-08-17.
# Parent: 89_02_sw3_bbfast_paperjrc_L123p4_kernel_SV_biot0p6.i -- 21.7% mean normalized RMSE, event 360-390 s early, largest post-event weakening of the SW-S3 set
#
...
#
# SW-S3 SPECIFIC -- and it is NOT the un-regated 123.40 mm preload (#75).  86_01 reaches a
# pre-event differential stress of 28.29 MPa and 89_02 reaches 28.52 MPa -- within 0.23 MPa of
# each other -- yet 86_01 fails on time and 89_02 fails 360-390 s early.  Identical preload,
# opposite timing, so the preload is exonerated and the ENVELOPE is the cause.
#
# The mechanism is the Barton roughness term.  JRC*log10(JCS/sigma'_n) is the NEGATIVE
# FEEDBACK that strengthens the joint as injection unloads it: dphi/dsigma'_n = -JRC/(ln10 *
# sigma'_n).  Collapsing JRC from 23.35 to the paper's measured 1.96 removes 92% of that
# feedback, and the measured margin decay steepens from 86_01's 2.93 %/MPa to 3.20 %/MPa
# while the level also drops (at 19 MPa: 86_01 +17.6%, 89_02 +11.4%).  This is the missing
# negative feedback flagged on 2026-08-16 -- it is on the STRENGTH side, not the aperture side.
#
# THIS ARM tests the LEVEL explanation, 90_06 tests the SLOPE explanation.  They are
# distinguishable: cohesion shifts the margin curve without tilting it, JRC tilts it.
#
# THIS DECK: add cohesion = 1.67e6 Pa, residual_cohesion = 0 (i.e. the peak gains 1.67 MPa and the
# residual is left exactly as 89_02 had it).  Derived: at the crossing state sigma'_n ~= 21 MPa,
# tau_lim = 21*tan(29.756 + 1.96*log10(150/21)) = 12.83 MPa; +13.0% is needed to move the
# crossing 4 MPa at the measured 3.2 %/MPa decay, and 13.0% of 12.83 is 1.67 MPa.
# Keeping the paper's measured JRC = 1.96 intact is the point of this arm.
#
# PREDICTION: crossing moves from 22-23 MPa to 26-27 MPa.  If 90_05 lands on time but still over-weakens after the event, the level was the whole story
# and residual_cohesion becomes the next knob.
# =============================================================================================
# ==============================================================================
...
[Materials]
  ...
  [czm_contact]
    ...
    residual_cohesion = 0.0           # residual deliberately unchanged from 89_02.
