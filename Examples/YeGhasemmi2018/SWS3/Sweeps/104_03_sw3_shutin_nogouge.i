...
use_slip_damage = false    # 104: 104_03: was true; the ONLY change from 101_11
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/104_03_sw3_shutin_nogouge_hpc
csv_file_base    = results_csv_hpc_rorqual/104_03_sw3_shutin_nogouge_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/104_03_sw3_shutin_nogouge_hpc
...
[Functions]
  ...
  # 104_03_sw3_shutin_nogouge   parent: 93_05_sw3_final_resc1p40_ppfix
  # mirrors: 101_11_sw3_shutin_nohold   (same schedule shape; see below)
  ...
  #
  # Shut-in instant t = 2569.2 s;  observation to t = 5569.2 s.
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2, 5.75e+06, if(t<2569.2, 5.75e+06+(2.857e+07-5.75e+06)*(t-2)/2567.2, if(t<2569.2, 2.857e+07, 5.75e+06+(2.857e+07-5.75e+06)*exp(-(t-2569.2)/150))))'
  []
