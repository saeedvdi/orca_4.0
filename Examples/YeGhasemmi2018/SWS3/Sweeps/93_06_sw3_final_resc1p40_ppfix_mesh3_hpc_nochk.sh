...
#SBATCH --job-name=93_06_sw3_final_resc1p40_ppfix_mesh3_hpc
...
#SBATCH --mem=128G
#SBATCH --output=logs/93_06_sw3_final_resc1p40_ppfix_mesh3_hpc_%j.out
#SBATCH --error=logs/93_06_sw3_final_resc1p40_ppfix_mesh3_hpc_%j.err
...
srun --mpi=pmi2 -n 128 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 93_06_sw3_final_resc1p40_ppfix_mesh3.i \
