...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/104_05_sw3_shutin_slowtau_hpc
csv_file_base    = results_csv_hpc_rorqual/104_05_sw3_shutin_slowtau_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/104_05_sw3_shutin_slowtau_hpc
...
[Functions]
  ...
  # 104_05_sw3_shutin_slowtau   parent: 93_05_sw3_final_resc1p40_ppfix
  ...
  #
  # Shut-in instant t = 2769.2 s;  observation to t = 8769.2 s.
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2, 5.75e+06, if(t<2569.2, 5.75e+06+(2.857e+07-5.75e+06)*(t-2)/2567.2, if(t<2769.2, 2.857e+07, 5.75e+06+(2.857e+07-5.75e+06)*exp(-(t-2769.2)/1500))))'
  []
