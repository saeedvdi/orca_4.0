...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/98_03_sw3_shutin_hpc
csv_file_base    = results_csv_hpc_rorqual/98_03_sw3_shutin_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/98_03_sw3_shutin_hpc
...
[Functions]
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2.0, 5.75e+06, if(t<2569.2, 5.75e+06+(2.857e+07-5.75e+06)*(t-2.0)/2567.2, if(t<2769.2, 2.857e+07, 5.75e+06+(2.857e+07-5.75e+06)*exp(-(t-2769.2)/150))))'
  []
