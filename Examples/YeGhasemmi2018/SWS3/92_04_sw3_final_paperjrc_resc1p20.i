...
#
# THIS DECK: residual_cohesion 1.65e6 -> 1.20e6 Pa.  Nothing else moves.  The value is inside the
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/92_04_sw3_final_paperjrc_resc1p20_hpc
csv_file_base    = results_csv_hpc_rorqual/92_04_sw3_final_paperjrc_resc1p20_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/92_04_sw3_final_paperjrc_resc1p20_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    residual_cohesion = 1.20e6   # 92_04: -0.45 MPa off 91_05, see header. 89_02 ran 0.0, 91_05 ran 1.65e6.
