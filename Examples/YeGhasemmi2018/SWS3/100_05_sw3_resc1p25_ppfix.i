# =============================================================================
# 100_05 REFINEMENT PROBE -- SW-S3
# Parent: 99_06_sw3_resc1p30_ppfix.i
# One strength axis only: residual cohesion 1.30 -> 1.25 MPa. The stagewise
# 1.40/1.30 MPa response fit places the aggregate minimum near 1.24 MPa, but
# predicts a shear-slip tradeoff; this conservative midpoint tests that trend.
# =============================================================================
# =============================================================================
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/100_05_sw3_resc1p25_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/100_05_sw3_resc1p25_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/100_05_sw3_resc1p25_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    residual_cohesion = 1.25e6   # 100_05: refinement near the fitted 1.24 MPa aggregate minimum
