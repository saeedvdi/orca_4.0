# =============================================================================
# 105_10 CALIBRATED MOHR-COULOMB UPPER BOUND -- SWS3
# Parent: 94_05_sw3_mc_final.i   Envelope source: orca_3.0_full deck 83_11
#
# SW-S3 calibrated Mohr-Coulomb (envelope + rate-and-state, full port).
#
...
# =============================================================================
# =============================================================================
# 94-SERIES -- MOHR-COULOMB BASELINE.  SW-S3 mesh 5
#
# Built from 93_05_sw3_final_resc1p40_ppfix.i by replacing ONE block: [czm_contact].
...
bb_stress_exponent = 2.0   # 105_10: 83_11 aperture-closure exponent; 94_05 used 4.0
...
slip_damage_scale = 0.28e-6   # 105_10: 83_11; 94_05 used 0.40e-6
...
slip_damage_onset_slip = 20e-6   # 105_10: 83_11; 94_05 used 30e-6
...
# --- output ---
exodus_file_base = results_exodus_hpc_rorqual/105_10_sw3_mc_calib_rsf_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/105_10_sw3_mc_calib_rsf_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/105_10_sw3_mc_calib_rsf_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    # BBFast sibling 94_05_sw3_mc_final.i.
    #
    ...
    roughness_decay_distance = 3.5e-5   # 105_10: 83_11 D_R; was 4.0e-5

    # --- Coulomb envelope transferred from Barton-Bandis --------------------
    friction_coefficient_rough = 1.125   # 105_10: 83_11; was 0.8818
    friction_coefficient_smooth = 0.096   # 105_10: 83_11; was 0.1486
    friction_roughness_exponent = 1.0     # linear in Rbar, matching BB's linear-in-W form
    cohesion_rough = 0.0   # 105_10: 83_11 COHESIONLESS; was 2.645e6
    cohesion_smooth = 0.0   # 105_10: 83_11 COHESIONLESS; was 1.400e6
    cohesion_roughness_exponent = 2.0   # 105_10: 83_11; was 1.0

    # --- dilation: copied verbatim from the BBFast sibling ------------------
    use_dilatancy = true
    dilation_angle_peak_degrees = 55.0   # 105_10: 83_11; parent used 26.0
    dilation_angle_residual_degrees = 38.0   # 105_10: 83_11; parent used 26.0
    ...
    tangential_viscosity = 7.5e11   # 105_10: 83_11; parent used 4.0e11
