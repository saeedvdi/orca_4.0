...
#SBATCH --job-name=sws4_117_05_wave1
...
#SBATCH --mem=32G
#SBATCH --output=logs/117_05_sws4_jrc1p19_m1p90_dc90_protocol_ppfix_%j.out
#SBATCH --error=logs/117_05_sws4_jrc1p19_m1p90_dc90_protocol_ppfix_%j.err

set -euo pipefail

PROJECT_ROOT=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0
CASE_STEM=117_05_sws4_jrc1p19_m1p90_dc90_protocol_ppfix
