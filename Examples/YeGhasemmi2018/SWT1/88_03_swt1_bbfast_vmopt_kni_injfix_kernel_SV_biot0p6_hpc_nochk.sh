...
#SBATCH --job-name=88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6
...
#SBATCH --mem=32G
#SBATCH --output=logs/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_%j.out
#SBATCH --error=logs/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6.i \
    ...
    csv_file_base=results_csv/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_hpc \
    exodus_file_base=results_exodus/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_hpc