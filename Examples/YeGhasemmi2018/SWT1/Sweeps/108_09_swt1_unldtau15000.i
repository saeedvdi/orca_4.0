# =============================================================================
# 108_09 -- SWT1 -- retention lag tau = 15000 s
#
...
#
# CHANGES FROM PARENT
#   1. end_time 3500 -> 63500 s (the paper protocol is untouched up to 3500 s;
...
#   4. normal_unload_retention_time 0.0 -> 15000 s.
#
# WHAT IT MEASURES
...
exodus_file_base = results_exodus_hpc_rorqual/108_09_swt1_unldtau15000
csv_file_base    = results_csv_hpc_rorqual/108_09_swt1_unldtau15000
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_09_swt1_unldtau15000
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.0 50.0 105.0 370.0 435.0 675.0 740.0 980.0 1045.0 1260.0 1340.0 1565.0 1640.0 1900.0 1960.0 2165.0 2220.0 2455.0 2515.0 2755.0 2820.0 3055.0 3125.0 3370.0 3500.0 63500'
...
[Materials]
  ...
  [czm_contact]
    ...
    normal_unload_retention_time = 15000   # 108 arm B: 0.0 in the parent (and in every other deck)
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 63500   # 108: protocol ends at 3500 s; the rest is the hold
  ...
  dtmax = 100   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 3500 s
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
