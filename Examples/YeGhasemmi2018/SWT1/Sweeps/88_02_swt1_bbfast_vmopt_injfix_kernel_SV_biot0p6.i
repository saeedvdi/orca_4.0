# =============================================================================
# 88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6.i
#
# SW-T1 normal-closure stiffness bracket, arm 88_02.
...
#
#     maximum_closure          4.5910e-05 -> 1.7359e-04   (3.78x)
#     initial_normal_stiffness 2.4430e+11 -> 2.4430e+11   (1.000x)
#     normal_closure_offset    4.4330e-05 -> 4.5728e-05
#
...
#   sigma'_n = 67 MPa      157.34 MPa/um       0.789 MPa/um
#   sigma'_n = 35 MPa       10.18 MPa/um       0.271 MPa/um
#
...
#
#     k_sys ~ 0.210 MPa/um     (parent 0.859, measured 0.135)
#
...
# =============================================================================
# ==============================================================================
# 88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6
...
exodus_file_base = results_exodus_hpc_rorqual/88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6_hpc
csv_file_base = results_csv_hpc_rorqual/88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    initial_normal_stiffness = 2.443000e+11
    maximum_closure = 1.735927e-04
    normal_closure_stress_exponent = 3.28
    normal_closure_offset = 4.572814e-05
