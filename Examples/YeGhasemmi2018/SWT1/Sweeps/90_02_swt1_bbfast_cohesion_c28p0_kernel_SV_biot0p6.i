# =============================================================================================
# 90_02_swt1_bbfast_cohesion_c28p0_kernel_SV_biot0p6
#
...
#   scored 26.7% mean normalized RMSE, event 530-595 s EARLY
#
...
#
# UPPER BRACKET ARM for 90_01.  Deliberately stronger than the derived value so the pair
# spans the target from both sides: if 90_01 still fails early and 90_02 survives the peak,
# the answer is between them and one interpolation finishes the calibration.
#
# THIS DECK: cohesion 2.465e7 -> 2.800e7 Pa (+3.35 MPa), i.e. 1.9x the derived correction.
#
# PREDICTION (falsifiable): crossing moves from 19-20 to 28+ MPa, i.e. failure on the top
...
# If the crossing lands short of 28+ MPa the level correction was under-estimated; if the
...
# without being updated. THIS DECK RUNS c = 28.00 MPa, c_res = 11.18 MPa. The refit fixes the parameterisation; the offset from it is calibrated, not derived.
#
...
checkpoint_file_base = results_checkpoint_hpc_rorqual/90_02_swt1_bbfast_cohesion_c28p0_kernel_SV_biot0p6_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 2.800e7          # asperity interlock of a MATED Mode-I fracture; pins the peak envelope through Table 2's last stick stage.
