# =============================================================================
# 106_13 SHEAR-STIFFNESS PROBE (MILD) -- SW-T1   (REQUIRES the orca_v9 source change)
# Parent: 100_01_swt1_vm55um_ppfix.i
#
...
# audit.
#
# Same axis as 106_12 at k_ref = 3.0e12 Pa/m instead of 1.18e12: 2.5x stiffer,
# recovering about 40 % of Table 2's pre-event creep (3.1 um of the 8 um) with a
# 22 um rather than 57 um shear datum.  This arm exists so the axis is bracketed
# rather than bet on, and so there is a fallback if 106_12's slip event misfires
# on SW-T1's 1.9 % strength margin.  Run both; read 106_12 first.
# =============================================================================
# =============================================================================
...
penalty_tangent = 3.0e12   # 106_13: now the tangential stiffness AT sigma_ref, not a fixed penalty. Was 1e13.
...
checkpoint_file_base = results_checkpoint_hpc_rorqual/106_13_swt1_ktbb_kref3p0e12_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    use_stress_dependent_tangential_stiffness = true   # 106_13: Barton-Bandis k_s ~ sigma'_n, see header.
