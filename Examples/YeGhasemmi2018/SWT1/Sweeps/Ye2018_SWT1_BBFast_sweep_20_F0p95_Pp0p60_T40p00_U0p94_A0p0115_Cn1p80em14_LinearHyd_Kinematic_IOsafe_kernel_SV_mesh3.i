...
# GENERATED 2026-08-15 from Ye2018_SWT1_BBFast_sweep_20_F0p95_Pp0p60_T40p00_U0p94_A0p0115_Cn1p80em14_LinearHyd_Kinematic_IOsafe_kernel_SV.i -- do not hand-edit; regenerate instead.
#
# Change applied on 2026-08-15:
#   mesh_file: ye2018_sw_T1_mesh_size_5.e -> ye2018_sw_T1_mesh_size_3.e
#     size 3 is the FINER mesh: 10,752 -> 117,232 elements (10.9x).
#
...
#
# The parent deck Ye2018_SWT1_BBFast_sweep_20_F0p95_Pp0p60_T40p00_U0p94_A0p0115_Cn1p80em14_LinearHyd_Kinematic_IOsafe_kernel_SV.i is left untouched.
# ==============================================================================
################################################################################
# HYDRAULIC REFINEMENT SWEEP V5 SWT1-20: STRESS-SENSITIVE KINEMATIC APERTURE
# Parent/control: Ye2018_SWT1_BBFast_sweep_19_F0p95_Pp0p60_T40p00_U0p94_A0p0160_Kinematic_IOsafe.
# Purpose: correct the post-peak permeability tail without changing v19 mechanics.
# Hydraulic-only change: reduce the mechanical-gap scale and activate a linear
# effective-normal-stress aperture term. All contact, loading, time-step, and
# I/O-safety settings are inherited unchanged from completed v19.
...
# kinematic hydraulic aperture scale A = 0.01150000
# hydraulic normal-closure type = linear effective-stress compliance
# hydraulic normal compliance Cn = 1.80000000e-14 m/Pa
...
aperture_scale = 0.0115
normal_stress_aperture_compliance = 1.8e-14
...
exodus_file_base = results_exodus/Ye2018_SWT1_BBFast_sweep_20_F0p95_Pp0p60_T40p00_U0p94_A0p0115_Cn1p80em14_LinearHyd_Kinematic_IOsafe_kernel_SV_mesh3
csv_file_base = results_csv/Ye2018_SWT1_BBFast_sweep_20_F0p95_Pp0p60_T40p00_U0p94_A0p0115_Cn1p80em14_LinearHyd_Kinematic_IOsafe_kernel_SV_mesh3
checkpoint_file_base = results_checkpoint/Ye2018_SWT1_BBFast_sweep_20_F0p95_Pp0p60_T40p00_U0p94_A0p0115_Cn1p80em14_LinearHyd_Kinematic_IOsafe_kernel_SV_mesh3
...
[Mesh]
  ...
  [source_in]
    ...
    coord = '-0.018945 0 0.03408166235'
  ...
  [source_out]
    type = ExtraNodesetGenerator
    input = source_in
    coord = '0.018945 0 0.09471833765'
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.000000 55.000000 75.000000 175.000000 405.000000 538.333333 705.000000 838.333333 1035.000000 1168.333333 1295.000000 1428.333333 1595.000000 1824.000000 1955.000000 2088.333333 2195.000000 2328.333333 2467.000000 2600.333333 2765.000000 2898.333333 3051.000000 3184.333333 3500.000000'
    y = '5000000 5000000 5000000 8000000 8000000 12000000 12000000 16000000 16000000 20000000 20000000 24000000 24000000 28000000 28000000 24000000 24000000 20000000 20000000 16000000 16000000 12000000 12000000 8000000 8000000'
  []
