# =============================================================================
# 100_02 REFINEMENT PROBE -- SW-T1
# Parent physics: 99_01 closure change plus the independently tested 99_02
# hydraulic change. maximum_closure remains 50.00 um with its recomputed offset;
# aperture_scale changes 0.0160 -> 0.0155. The 99-series response superposition
# predicts mean nRMSE near 3.24%; this run tests the interaction directly.
# =============================================================================
# =============================================================================
...
aperture_scale = 0.0155 # 100_02: combine independently beneficial 99_01 and 99_02 axes
...
exodus_file_base = results_exodus_hpc_rorqual/100_02_swt1_vm50um_apscale0p0155_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/100_02_swt1_vm50um_apscale0p0155_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/100_02_swt1_vm50um_apscale0p0155_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    maximum_closure = 5.000e-5       # 99_01: 50.00 um closure bracket
    normal_closure_stress_exponent = 3.28
    normal_closure_offset = 4.77493315336e-5 # 99_01: closure(31 MPa), preserves initial seating
