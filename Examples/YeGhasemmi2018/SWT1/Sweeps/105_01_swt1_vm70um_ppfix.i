# =============================================================================
# 105_01 CONTROLLED CALIBRATION PROBE -- SW-T1
# Parent: 93_01_swt1_final_c26p9_resc9p19_ppfix.i
#
# One material axis only: mechanical BB maximum closure 45.91 -> 70.00 um.
# The closure offset is recomputed at sigma_n = 31 MPa (44.3306 -> 61.2897 um) so the initial joint seating is
...
#
# NOTE ON SOFTNESS.  sigma_0 = K_ni V_m = 17.10 MPa here, against the
# 31 MPa preload, so the seated closure ratio c/V_m falls to 0.8756
...
exodus_file_base = results_exodus_hpc_rorqual/105_01_swt1_vm70um_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/105_01_swt1_vm70um_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/105_01_swt1_vm70um_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    maximum_closure = 7.000e-5       # 105_01: 70.00 um continuation bracket
    normal_closure_stress_exponent = 3.28
    normal_closure_offset = 6.128972512046e-5 # 105_01: closure(31 MPa), preserves initial seating
