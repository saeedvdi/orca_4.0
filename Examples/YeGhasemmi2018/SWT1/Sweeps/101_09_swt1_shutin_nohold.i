...
exodus_file_base = results_exodus_hpc_rorqual/101_09_swt1_shutin_nohold_hpc
csv_file_base    = results_csv_hpc_rorqual/101_09_swt1_shutin_nohold_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_09_swt1_shutin_nohold_hpc
...
[Functions]
  ...
  # 101_09_swt1_shutin_nohold   parent: 93_01_swt1_final_c26p9_resc9p19_ppfix
  #
  ...
  # specimen's own rate, hold 0 s, then shut in: the injection node relaxes
  # exponentially toward ambient with tau = 150 s.
  # Shut-in instant t = 1640.0 s;  3000 s of observation after it.
  #
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2, 5e+06, if(t<1640, 5e+06+(2.8e+07-5e+06)*(t-2)/1638, if(t<1640, 2.8e+07, 5e+06+(2.8e+07-5e+06)*exp(-(t-1640)/150))))'
  []
