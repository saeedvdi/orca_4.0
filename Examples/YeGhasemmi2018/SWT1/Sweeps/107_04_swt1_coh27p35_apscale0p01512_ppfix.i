# =============================================================================
# 107_04 SWT1 ADAPTIVE EVENT-TIMING PROBE -- peak cohesion 27.35 MPa
...
# physics change: 26.88 -> 27.35 MPa.  This is the single midpoint refinement
# between 107_01 (event at 1683.83 s) and 107_02 (locked through 1760 s).
# The accepted hydraulic aperture scale
...
# without being updated. THIS DECK RUNS c = 27.35 MPa, c_res = 9.19 MPa. The refit fixes the parameterisation; the offset from it is calibrated, not derived.
#
...
exodus_file_base = results_exodus_local/107_04_swt1_coh27p35_apscale0p01512_ppfix
csv_file_base    = results_csv_local/107_04_swt1_coh27p35_apscale0p01512_ppfix
checkpoint_file_base = results_checkpoint_local/107_04_swt1_coh27p35_apscale0p01512_ppfix
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 2.735e7 # 107_04: adaptive midpoint; parent 106_01 used 2.688e7.
