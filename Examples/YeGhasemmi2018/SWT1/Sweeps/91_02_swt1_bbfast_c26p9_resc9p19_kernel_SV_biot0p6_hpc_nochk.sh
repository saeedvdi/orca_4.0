...
#SBATCH --job-name=91_02_swt1_bbfast_c26p9_resc9p19_kernel_SV_biot0p6_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/91_02_swt1_bbfast_c26p9_resc9p19_kernel_SV_biot0p6_hpc_%j.out
#SBATCH --error=logs/91_02_swt1_bbfast_c26p9_resc9p19_kernel_SV_biot0p6_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 91_02_swt1_bbfast_c26p9_resc9p19_kernel_SV_biot0p6.i \
