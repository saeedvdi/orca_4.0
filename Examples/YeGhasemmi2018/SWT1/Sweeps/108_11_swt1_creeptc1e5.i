# =============================================================================
# 108_11 -- SWT1 -- closure creep tau_c = 1e5 s
#
...
#
# CHANGES FROM PARENT
#   1. end_time 3500 -> 1.0035e+06 s (the paper protocol is untouched up to 3500 s;
...
#      closure_creep_time = 100000 s at the specimen's own reference stress.
#
# WHAT IT MEASURES
...
#   a_c_max = 1.9132 um = this run's own retained gain, a_h(T_p) - a_h0.
...
exodus_file_base = results_exodus_hpc_rorqual/108_11_swt1_creeptc1e5
csv_file_base    = results_csv_hpc_rorqual/108_11_swt1_creeptc1e5
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_11_swt1_creeptc1e5
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.0 50.0 105.0 370.0 435.0 675.0 740.0 980.0 1045.0 1260.0 1340.0 1565.0 1640.0 1900.0 1960.0 2165.0 2220.0 2455.0 2515.0 2755.0 2820.0 3055.0 3125.0 3370.0 3500.0 1.0035e+06'
...
[Materials]
  ...
  [czm_aperture]
    ...
    closure_creep_max_aperture = 1.9132e-06
    closure_creep_time = 100000
    closure_creep_reference_stress = 65.47e6
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 1.0035e+06   # 108: protocol ends at 3500 s; the rest is the hold
  ...
  dtmax = 2000   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 3500 s
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
