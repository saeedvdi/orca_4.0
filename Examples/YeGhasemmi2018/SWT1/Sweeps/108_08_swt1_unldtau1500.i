# =============================================================================
# 108_08 -- SWT1 -- retention lag tau = 1500 s
#
...
#   4. normal_unload_retention_time 0.0 -> 1500 s.
#
# WHAT IT MEASURES
...
exodus_file_base = results_exodus_hpc_rorqual/108_08_swt1_unldtau1500
csv_file_base    = results_csv_hpc_rorqual/108_08_swt1_unldtau1500
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_08_swt1_unldtau1500
...
[Materials]
  ...
  [czm_contact]
    ...
    normal_unload_retention_time = 1500   # 108 arm B: 0.0 in the parent (and in every other deck)
