# =============================================================================
# 88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6.i
#
# SW-T1 normal-closure stiffness bracket, arm 88_03.
# same, plus K_ni x0.582 -- the only way past the fixed-K_ni floor
#
# Derived from 87_01 (the injection-schedule-corrected deck). ONLY the
# Barton-Bandis closure constants differ:
#
#     maximum_closure          4.5910e-05 -> 2.9841e-04   (6.50x)
#     initial_normal_stiffness 2.4430e+11 -> 1.4212e+11   (0.582x)
#     normal_closure_offset    4.4330e-05 -> 7.8608e-05
#
# The offset is re-solved so the PRE-SEATED STRESS AT ZERO MECHANICAL OVERLAP is
# unchanged at 31.00 MPa. That invariant keeps the preload state and the
...
#   sigma'_n = 67 MPa      157.34 MPa/um       0.459 MPa/um
#   sigma'_n = 35 MPa       10.18 MPa/um       0.158 MPa/um
#
# TARGET. The measured joint+frame unloading stiffness is 0.135 MPa/um; 87_01
# delivers 0.859 MPa/um, 6.4x too stiff. That single number is BOTH reported
...
# the inferred k_frame = 0.938 MPa/um:
#
#     k_sys ~ 0.135 MPa/um     (parent 0.859, measured 0.135)
#
...
# only slides the joint along a fixed curve whose minimum is 0.271 MPa/um at
# K_ni = 2.443e+11 -- above the 0.158 MPa/um the series pair needs. So V_m alone
# PROVABLY cannot reach the measured compliance, and arm 88_03 scales K_ni by
# 0.582 to get past that floor. 88_01/88_02 bracket how much of the misfit V_m
...
# =============================================================================
# ==============================================================================
# 88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6
...
exodus_file_base = results_exodus_hpc_rorqual/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_hpc
csv_file_base = results_csv_hpc_rorqual/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/88_03_swt1_bbfast_vmopt_kni_injfix_kernel_SV_biot0p6_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    initial_normal_stiffness = 1.421159e+11
    maximum_closure = 2.984092e-04
    normal_closure_stress_exponent = 3.28
    normal_closure_offset = 7.860756e-05
    ...
    jrc = 15.32
    jcs = 1.5e8
    residual_friction_angle_degrees = 44.1
    ...
    slip_weakening_residual_friction_angle_degrees = 40
