# =============================================================================
# 108_03 -- SWT1 -- reconfinement to 3.5x sigma_3
#
# Parent: 100_01_swt1_vm55um_ppfix.i  (unchanged except where listed below)
...
#
# CHANGES FROM PARENT
#   1. end_time 3500 -> 6200 s (the paper protocol is untouched up to 3500 s;
...
#      returns the parent's cap up to t = 3500 s. The calibrated window is stepped
...
#   4. sigma3_x/sigma3_y are multiplied by a reconfinement factor that is 1.0 for
#      t <= 3500 s and then steps 1.5 / 2.0 / 2.5 / 3.0 / 3.5 in 350 s holds.
...
exodus_file_base = results_exodus_hpc_rorqual/108_03_swt1_reconf3p5x
csv_file_base    = results_csv_hpc_rorqual/108_03_swt1_reconf3p5x
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_03_swt1_reconf3p5x
...
[Functions]
  [reconfine_factor]
    ...
    x = '0 3500 3700 3850 4200 4350 4700 4850 5200 5350 5700 5850 6200'
    y = '1 1 1 1.5 1.5 2 2 2.5 2.5 3 3 3.5 3.5'
  []
  ...
  [injection_pressure]
    ...
    type = PiecewiseLinear
    x = '0.0 50.0 105.0 370.0 435.0 675.0 740.0 980.0 1045.0 1260.0 1340.0 1565.0 1640.0 1900.0 1960.0 2165.0 2220.0 2455.0 2515.0 2755.0 2820.0 3055.0 3125.0 3370.0 3500.0 6200'
    y = '5e+06 5e+06 8e+06 8e+06 1.2e+07 1.2e+07 1.6e+07 1.6e+07 2e+07 2e+07 2.4e+07 2.4e+07 2.8e+07 2.8e+07 2.4e+07 2.4e+07 2e+07 2e+07 1.6e+07 1.6e+07 1.2e+07 1.2e+07 8e+06 8e+06 8e+06 8e+06'
  []
  ...
  []
  [sigma3_x]
    # 108 arm A: the parent's own sigma3_x, scaled by the reconfinement
    # ladder. Composing rather than rewriting preserves any time dependence
    # the parent already had in this function.
    type = CompositeFunction
    functions = 'reconfine_factor sigma3_x_base'
  []
  [sigma3_y_base]
    type = ParsedFunction
  ...
  []
  [sigma3_y]
    # 108 arm A: the parent's own sigma3_y, scaled by the reconfinement
    # ladder. Composing rather than rewriting preserves any time dependence
    # the parent already had in this function.
    type = CompositeFunction
    functions = 'reconfine_factor sigma3_y_base'
  []
[]
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 6200   # 108: protocol ends at 3500 s; the rest is the hold
  ...
  dtmax = 2   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 3500 s
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
