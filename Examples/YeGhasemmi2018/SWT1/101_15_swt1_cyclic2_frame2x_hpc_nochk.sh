...
#SBATCH --job-name=101_15_swt1_cyclic2_frame2x_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/101_15_swt1_cyclic2_frame2x_hpc_%j.out
#SBATCH --error=logs/101_15_swt1_cyclic2_frame2x_hpc_%j.err
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 101_15_swt1_cyclic2_frame2x.i \
