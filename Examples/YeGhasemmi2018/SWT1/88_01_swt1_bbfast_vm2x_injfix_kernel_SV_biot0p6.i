# =============================================================================
# 88_01_swt1_bbfast_vm2x_injfix_kernel_SV_biot0p6.i
#
# SW-T1 normal-closure stiffness bracket, arm 88_01.
...
#
#     maximum_closure          4.5910e-05 -> 9.1820e-05   (2.00x)
#     initial_normal_stiffness 2.4430e+11 -> 2.4430e+11   (1.000x)
#     normal_closure_offset    4.4330e-05 -> 6.8206e-05
#
...
#   sigma'_n = 67 MPa      157.34 MPa/um       8.504 MPa/um
#   sigma'_n = 35 MPa       10.18 MPa/um       0.759 MPa/um
#
...
#
#     k_sys ~ 0.420 MPa/um     (parent 0.859, measured 0.135)
#
...
# =============================================================================
# ==============================================================================
# 88_01_swt1_bbfast_vm2x_injfix_kernel_SV_biot0p6
...
exodus_file_base = results_exodus/88_01_swt1_bbfast_vm2x_injfix_kernel_SV_biot0p6
csv_file_base = results_csv/88_01_swt1_bbfast_vm2x_injfix_kernel_SV_biot0p6
checkpoint_file_base = results_checkpoint/88_01_swt1_bbfast_vm2x_injfix_kernel_SV_biot0p6
...
[Materials]
  ...
  [czm_contact]
    ...
    maximum_closure = 9.182000e-05
    normal_closure_stress_exponent = 3.28
    normal_closure_offset = 6.820637e-05
