...
#SBATCH --job-name=101_13_swt1_shutin_slowtau_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/101_13_swt1_shutin_slowtau_hpc_%j.out
#SBATCH --error=logs/101_13_swt1_shutin_slowtau_hpc_%j.err
...
# is ~9.6 h, so --time=24:00:00.  The 97-series jobs died because they
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 101_13_swt1_shutin_slowtau.i \
