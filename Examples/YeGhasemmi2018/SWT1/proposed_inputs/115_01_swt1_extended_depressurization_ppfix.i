# PAPER-COMPELLING MATRIX 2026-09-02
# Purpose: Elastic-closure diagnostic: hold the final post-slip state, then reduce the inlet-to-outlet pressure difference to 50 and 15 percent of its original final value.
# Parent deck: 111_01_swt1_floor1nm_control_ppfix.i; every unlisted parameter is unchanged.

# =============================================================================
# 111_01 -- SW-T1 calibrated kinematic aperture with a relaxed lower bound
#
# Parent: 107_01_swt1_coh27p2_apscale0p01512_ppfix.i
# Controlled change: min_hydraulic_aperture 1.5105e-6 -> 1.0e-9 m.
# Purpose: determine whether the selected tensile-fracture hydraulic response is
#          influenced by its lower aperture bound. All mechanics and aperture
#          mapping parameters remain unchanged. This is a diagnostic control.
# =============================================================================
# =============================================================================
...
# changing the accurately matched hold-stage levels?  Only peak cohesion is a
# physics change: 26.88 -> 27.20 MPa.  The accepted hydraulic aperture scale
# remains 0.01512; residual cohesion, closure, dilation, loading, and coupling
# remain unchanged.  The common fine-step window is extended from 1680 to
# 1850 s solely to resolve a delayed event consistently across the bracket.
# =============================================================================
# =============================================================================
# 106_01 APERTURE-LEVEL PROBE -- SW-T1
# Parent: 100_01_swt1_vm55um_ppfix.i  (mean nRMSE 2.689 %, best SW-T1 on disk)
#
# ONE LINE CHANGES: aperture_scale 0.016000 -> 0.015120.
#
# The parent's hydraulic aperture is 0.12-0.20 um TOO OPEN at every post-event
# stage (6-11) and its flow is correspondingly 9-18 % high, while stages 1-5 sit
# within 0.09 um.  With normal_stress_aperture_compliance = 0 and the nonlinear
# closure off, the parent's a_h is exactly a_h0 + aperture_scale*mechanical_aperture,
# so the post-event block is a pure scale error and a single least-squares fit of
# aperture_scale against Table 2 stages 6-11 removes it.  This is the minimal,
# no-new-terms version of that fit; 106_02 is the version that also restores a
# stress-dependent term.  Predicted Q nRMSE 4.511 -> 1.125 %, mean 2.689 -> 2.01 %.
...
# without being updated. THIS DECK RUNS c = 27.20 MPa, c_res = 9.19 MPa. The refit fixes the parameterisation; the offset from it is calibrated, not derived.
#
...
# 1740--1825 s event window. I/O safety: CSV every fifth step (0.25 s at the
# event); Exodus only at FINAL;
...
aperture_scale = 0.01512  # 106_01: LS fit of Table 2 stages 6-11. Was 0.016.
...
min_hydraulic_aperture = 1.0e-9  # 111_01 diagnostic: relaxed aperture bound
...
exodus_file_base = proposed_inputs/paper_compelling_20260902/exodus/115_01_swt1_extended_depressurization_ppfix
csv_file_base    = proposed_inputs/paper_compelling_20260902/csv/115_01_swt1_extended_depressurization_ppfix
checkpoint_file_base = proposed_inputs/paper_revision_20260901_tensile_followup/checkpoint/115_01_swt1_extended_depressurization_ppfix
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.0 50.0 105.0 370.0 435.0 675.0 740.0 980.0 1045.0 1260.0 1340.0 1565.0 1640.0 1900.0 1960.0 2165.0 2220.0 2455.0 2515.0 2755.0 2820.0 3055.0 3125.0 3370.0 3500.0 3700 3900 4100 4300 4500'
    y = '5e+06 5e+06 8e+06 8e+06 1.2e+07 1.2e+07 1.6e+07 1.6e+07 2e+07 2e+07 2.4e+07 2.4e+07 2.8e+07 2.8e+07 2.4e+07 2.4e+07 2e+07 2e+07 1.6e+07 1.6e+07 1.2e+07 1.2e+07 8e+06 8e+06 8e+06 8e6 6.5e6 6.5e6 5.45e6 5.45e6'
  []
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 2.720e7 # 107_01: peak-strength timing probe; parent 106_01 used 2.688e7.
