...
#SBATCH --job-name=88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6_hpc_%j.out
#SBATCH --error=logs/88_02_swt1_bbfast_vmopt_injfix_kernel_SV_biot0p6_hpc_%j.err
