# =============================================================================
# 106_04 CORNER -- SW-T1  (106_02 hydraulic closure + 106_03 unload reclosure)
# Parent: 100_01_swt1_vm55um_ppfix.i
#
# Carries BOTH single-axis changes:
#   106_02  aperture_scale 0.016 -> 0.01236, nonlinear hydraulic closure ON,
#           V_h 9.8398 um, K_h 1.3655e12 Pa/m, p 3.28   (targets Q)
#   106_03  normal_unload_retention_fraction 0.94 -> 0.70  (targets d_n)
#
# The two axes are expected to be close to orthogonal -- the first changes only
# how a_h is assembled from the mechanical state, the second changes the
# mechanical state itself on unloading -- but that is a hypothesis, and this arm
# is only interpretable once 106_02 and 106_03 have both scored.  Precedent for
# the orthogonality claim: 99_01 -> 100_02 added aperture_scale at fixed V_m and
# moved ONLY Q (6.15 -> 4.03 %), leaving the other four channels identical to
# three digits.  Read this deck last.
# =============================================================================
# =============================================================================
...
exodus_file_base = results_exodus_hpc_rorqual/106_04_swt1_hydbb_unld0p70_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/106_04_swt1_hydbb_unld0p70_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/106_04_swt1_hydbb_unld0p70_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    normal_unload_retention_fraction = 0.70   # 106_04: from 106_03. Was 0.94.
