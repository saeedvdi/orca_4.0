# =============================================================================
# 105_03 CONTROLLED CALIBRATION PROBE -- SW-T1
# Parent: 93_01_swt1_final_c26p9_resc9p19_ppfix.i
#
# One material axis only: mechanical BB maximum closure 45.91 -> 110.00 um.
# The closure offset is recomputed at sigma_n = 31 MPa (44.3306 -> 67.6557 um) so the initial joint seating is
...
#
# NOTE ON SOFTNESS.  sigma_0 = K_ni V_m = 26.87 MPa here, against the
# 31 MPa preload, so the seated closure ratio c/V_m falls to 0.6151
...
exodus_file_base = results_exodus_hpc_rorqual/105_03_swt1_vm110um_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/105_03_swt1_vm110um_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/105_03_swt1_vm110um_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    maximum_closure = 1.100e-4       # 105_03: 110.00 um continuation bracket
    normal_closure_stress_exponent = 3.28
    normal_closure_offset = 6.765569657144e-5 # 105_03: closure(31 MPa), preserves initial seating
