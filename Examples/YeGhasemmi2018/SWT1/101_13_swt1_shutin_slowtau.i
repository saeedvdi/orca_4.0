...
exodus_file_base = results_exodus_hpc_rorqual/101_13_swt1_shutin_slowtau_hpc
csv_file_base    = results_csv_hpc_rorqual/101_13_swt1_shutin_slowtau_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_13_swt1_shutin_slowtau_hpc
...
[Functions]
  ...
  # 101_13_swt1_shutin_slowtau   parent: 93_01_swt1_final_c26p9_resc9p19_ppfix
  #
  ...
  #
  # Ramp 5.00 -> 28.00 MPa over t = 2 .. 1640.0 s at this
  # specimen's own rate, hold 200 s, then shut in: the injection node relaxes
  # exponentially toward ambient with tau = 1500 s.
  # Shut-in instant t = 1840.0 s;  6000 s of observation after it.
  #
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2, 5e+06, if(t<1640, 5e+06+(2.8e+07-5e+06)*(t-2)/1638, if(t<1840, 2.8e+07, 5e+06+(2.8e+07-5e+06)*exp(-(t-1840)/1500))))'
  []
