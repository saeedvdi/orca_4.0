...
#SBATCH --job-name=104_04_swt2_shutin_slowtau_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/104_04_swt2_shutin_slowtau_hpc_%j.out
#SBATCH --error=logs/104_04_swt2_shutin_slowtau_hpc_%j.err
...
# deck runs 8480 s at dtmax = 0.75 s, i.e. >= 11307 steps.  At the
# measured 5.3 s/step on 16 ranks and an assumed 1.6x from 16 -> 32 ranks, that
# is ~10.4 h, so --time=24:00:00.  The 97-series jobs died because they
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 104_04_swt2_shutin_slowtau.i \
