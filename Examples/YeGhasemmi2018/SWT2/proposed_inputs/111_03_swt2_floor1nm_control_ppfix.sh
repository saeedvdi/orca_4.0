...
#SBATCH --mem=24G
#SBATCH --output=proposed_inputs/paper_revision_20260901_tensile_followup/logs/111_03_swt2_floor1nm_control_ppfix_%j.out
#SBATCH --error=proposed_inputs/paper_revision_20260901_tensile_followup/logs/111_03_swt2_floor1nm_control_ppfix_%j.err

set -euo pipefail

PROJECT_ROOT=/home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0
CASE_STEM=111_03_swt2_floor1nm_control_ppfix
