...
exodus_file_base = results_exodus_hpc_rorqual/104_04_swt2_shutin_slowtau_hpc
csv_file_base    = results_csv_hpc_rorqual/104_04_swt2_shutin_slowtau_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/104_04_swt2_shutin_slowtau_hpc
...
[Functions]
  ...
  # 104_04_swt2_shutin_slowtau   parent: 93_03_swt2_final_theta30_resc9p71_ppfix
  # mirrors: 101_10_swt2_shutin_nohold   (same schedule shape; see below)
  # parameter change from that mirror: NONE (schedule only)
  #
  ...
  #
  # Shut-in instant t = 2480.0 s;  observation to t = 8480.0 s.
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2, 5e+06, if(t<2280, 5e+06+(2.8e+07-5e+06)*(t-2)/2278, if(t<2480, 2.8e+07, 5e+06+(2.8e+07-5e+06)*exp(-(t-2480)/1500))))'
  []
