...
#SBATCH --job-name=101_10_swt2_shutin_nohold_hpc
...
#SBATCH --mem=32G
#SBATCH --output=logs/101_10_swt2_shutin_nohold_hpc_%j.out
#SBATCH --error=logs/101_10_swt2_shutin_nohold_hpc_%j.err
...
# deck runs 5280 s at dtmax = 0.75 s, i.e. >= 7041 steps.  At the
...
srun --mpi=pmi2 -n 32 /home/saeedvdi/links/projects/def-biaoli66/saeedvdi/projects/orca_4.0/orca-opt -i 101_10_swt2_shutin_nohold.i \
