# =============================================================================
# 108_04 -- SWT2 -- reconfinement to 3.5x sigma_3
#
# Parent: 100_04_swt2_apscale0p0177_ppfix.i  (unchanged except where listed below)
...
#
# CHANGES FROM PARENT
#   1. end_time 2852.53 -> 5552.53 s (the paper protocol is untouched up to 2852.53 s;
...
#      returns the parent's cap up to t = 2852.53 s. The calibrated window is stepped
...
#      t <= 2852.53 s and then steps 1.5 / 2.0 / 2.5 / 3.0 / 3.5 in 350 s holds.
...
exodus_file_base = results_exodus_hpc_rorqual/108_04_swt2_reconf3p5x
csv_file_base    = results_csv_hpc_rorqual/108_04_swt2_reconf3p5x
checkpoint_file_base = results_checkpoint_hpc_rorqual/108_04_swt2_reconf3p5x
...
[Functions]
  [reconfine_factor]
    ...
    x = '0 2852.53 3052.53 3202.53 3552.53 3702.53 4052.53 4202.53 4552.53 4702.53 5052.53 5202.53 5552.53'
  ...
  [injection_pressure]
    ...
    type = PiecewiseLinear
    x = '0.0 60.0 130.0 480.0 565.0 995.0 1070.0 1360.0 1460.0 1755.0 1850.0 2145.0 2280.0 2500.0 2510.0 2560.0 2570.0 2605.0 2615.0 2650.0 2660.0 2705.0 2725.0 2830.0 2852.5 5552.53'
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 5552.53   # 108: protocol ends at 2852.53 s; the rest is the hold
  ...
  dtmax = 2   # 108: parent 0.75; the FunctionDT in [TimeSteppers] still enforces 0.75 up to t = 2852.53 s
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
