# =============================================================================================
# 90_04_swt2_bbfast_theta30_cohesion_c35p0_kernel_SV_biot0p6
#
...
#   scored 24.9% mean normalized RMSE, event 430-445 s EARLY, best final state of the SW-T2 set
#
...
#
# UPPER BRACKET ARM for 90_03, same logic as 90_02 on SW-T1.
#
# THIS DECK: cohesion 3.165e7 -> 3.500e7 Pa (+3.35 MPa), i.e. 2.2x the derived correction.
#
# PREDICTION (falsifiable): crossing moves from 21 to 28+ MPa, i.e. failure on the top
...
#    without being updated. THIS DECK RUNS c = 35.00 MPa, c_res = 10.70 MPa. The refit fixes the parameterisation; the offset from it is calibrated, not derived.
#
...
exodus_file_base = results_exodus_hpc_rorqual/90_04_swt2_bbfast_theta30_cohesion_c35p0_kernel_SV_biot0p6_hpc
csv_file_base    = results_csv_hpc_rorqual/90_04_swt2_bbfast_theta30_cohesion_c35p0_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/90_04_swt2_bbfast_theta30_cohesion_c35p0_kernel_SV_biot0p6_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 3.500e7          # asperity interlock of a MATED Mode-I fracture; pins the peak envelope through Table 2's last stick stage.
