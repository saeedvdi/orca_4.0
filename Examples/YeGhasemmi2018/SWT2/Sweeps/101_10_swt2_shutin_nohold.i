...
exodus_file_base = results_exodus_hpc_rorqual/101_10_swt2_shutin_nohold_hpc
csv_file_base    = results_csv_hpc_rorqual/101_10_swt2_shutin_nohold_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/101_10_swt2_shutin_nohold_hpc
...
[Functions]
  ...
  # 101_10_swt2_shutin_nohold   parent: 93_03_swt2_final_theta30_resc9p71_ppfix
  #
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2, 5e+06, if(t<2280, 5e+06+(2.8e+07-5e+06)*(t-2)/2278, if(t<2280, 2.8e+07, 5e+06+(2.8e+07-5e+06)*exp(-(t-2280)/150))))'
  []
