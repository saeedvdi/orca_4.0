...
# GENERATED 2026-08-15 from Ye2018_SWT2_BBFast_sweep_22_F0p90_Pp0p55_T40p20_U0p84_A0p0165_BBhyd_Timing_IOsafe_kernel_SV.i -- do not hand-edit; regenerate instead.
#
# Change applied on 2026-08-15:
#   mesh_file: ye2018_sw_T2_mesh_size_5.e -> ye2018_sw_T2_mesh_size_3.e
...
#
# The parent deck Ye2018_SWT2_BBFast_sweep_22_F0p90_Pp0p55_T40p20_U0p84_A0p0165_BBhyd_Timing_IOsafe_kernel_SV.i is left untouched.
# ==============================================================================
################################################################################
# CONTROLLED REFINEMENT SWEEP V5 SWT2-22
# Parent/control: Ye2018_SWT2_BBFast_sweep_21_F0p90_Pp0p60_T40p20_U0p84_A0p0165_BBhyd_IOsafe.
# Purpose: timing-only test: advance the v21 stress-drop event by reducing the peak-friction offset from 0.60 to 0.55 degree.
# Controlled change family: peak-friction timing only; all other v21 mechanics are retained.
# frame factor = 0.900
# peak friction offset = 0.550 deg
...
# hydraulic closure Vm = 1.2000 um
# hydraulic closure Kni = 1.250000e+13 Pa/m
# hydraulic closure exponent p = 4.0000
# hydraulic closure characteristic stress = 15.000 MPa
# I/O safety: CSV every step; Exodus only at FINAL; one checkpoint
# generation retained every 800 time steps.
# Output stem: Ye2018_SWT2_BBFast_sweep_22_F0p90_Pp0p55_T40p20_U0p84_A0p0165_BBhyd_Timing_IOsafe
################################################################################
...
mesh_file = mesh/ye2018_sw_T2_mesh_size_3.e
...
bb_max_aperture_closure = 1.2e-06

bb_initial_normal_stiffness = 1.25e+13
bb_stress_exponent = 4
dilation_scale = 0.0
...
exodus_file_base = results_exodus/Ye2018_SWT2_BBFast_sweep_22_F0p90_Pp0p55_T40p20_U0p84_A0p0165_BBhyd_Timing_IOsafe_kernel_SV_mesh3
csv_file_base = results_csv/Ye2018_SWT2_BBFast_sweep_22_F0p90_Pp0p55_T40p20_U0p84_A0p0165_BBhyd_Timing_IOsafe_kernel_SV_mesh3
checkpoint_file_base = results_checkpoint/Ye2018_SWT2_BBFast_sweep_22_F0p90_Pp0p55_T40p20_U0p84_A0p0165_BBhyd_Timing_IOsafe_kernel_SV_mesh3
...
[Mesh]
  ...
  [source_in]
    ...
    coord = '-0.01976869565 0 0.03344936545'
  ...
  [source_out]
    type = ExtraNodesetGenerator
    input = source_in
    coord = '0.01976869565 0 0.09925063455'
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.000000 55.000000 105.000000 205.000000 530.000000 663.333333 1025.000000 1158.333333 1403.000000 1536.333333 1808.000000 1941.333333 2172.000000 2359.000000 2541.000000 2568.000000 2616.000000 2619.000000 2667.000000 2670.000000 2710.000000 2713.000000 2739.000000 2771.000000 2852.530000'
...
[Materials]
  ...
  [czm_contact]
    ...
    jrc = 14.63
    jcs = 1.5e8
    residual_friction_angle_degrees = 46.24182452
    ...
    slip_weakening_residual_friction_angle_degrees = 40.2
...
[Postprocessors]
  ...
  [effective_normal_paper_frame_mpa_pp]
    ...
    expression = '30.0 - 0.5*(injection_pressure_pp + pp_outlet_pp)*1e-6 + 0.265264218607055*differential_stress_reaction_mpa_pp'
  []
  [shear_stress_paper_frame_mpa_pp]
    type = ParsedPostprocessor
    pp_names = differential_stress_reaction_mpa_pp
    expression = '0.441473796429463*differential_stress_reaction_mpa_pp'
  []
