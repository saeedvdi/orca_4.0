# ==============================================================================
# 89_05_swt2_bbfast_theta30_cohesion_kernel_SV_biot0p6
...
#    without being updated. THIS DECK RUNS c = 31.65 MPa, c_res = 10.70 MPa. Unchanged from the refit.
#
...
exodus_file_base = results_exodus_hpc_rorqual/89_05_swt2_bbfast_theta30_cohesion_kernel_SV_biot0p6_hpc
csv_file_base    = results_csv_hpc_rorqual/89_05_swt2_bbfast_theta30_cohesion_kernel_SV_biot0p6_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/89_05_swt2_bbfast_theta30_cohesion_kernel_SV_biot0p6_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 3.165e7          # asperity interlock of a MATED Mode-I fracture; pins the peak envelope through Table 2's last stick stage.
