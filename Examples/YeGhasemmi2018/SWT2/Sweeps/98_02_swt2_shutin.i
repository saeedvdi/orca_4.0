...
exodus_file_base = results_exodus_hpc_rorqual/98_02_swt2_shutin_hpc
csv_file_base    = results_csv_hpc_rorqual/98_02_swt2_shutin_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/98_02_swt2_shutin_hpc
...
[Functions]
  ...
  [injection_pressure]
    type = ParsedFunction
    expression = 'if(t<2.0, 5e+06, if(t<2280, 5e+06+(2.8e+07-5e+06)*(t-2.0)/2278, if(t<2480, 2.8e+07, 5e+06+(2.8e+07-5e+06)*exp(-(t-2480)/150))))'
  []
