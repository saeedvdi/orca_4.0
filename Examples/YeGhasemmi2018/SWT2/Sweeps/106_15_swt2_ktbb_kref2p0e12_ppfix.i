# =============================================================================
# 106_15 SHEAR-STIFFNESS PROBE (MILD) -- SW-T2   (REQUIRES the orca_v9 source change)
...
# audit.
#
# Same axis as 106_14 at k_ref = 2.0e12 Pa/m instead of 6.86e11: 2.9x stiffer,
# recovering about 34 % of Table 2's pre-event creep (5.1 um of the 15 um) with a
# 37 um rather than 109 um shear datum.  Bracket arm and fallback, exactly as
# 106_13 is for SW-T1.  Run both; read 106_14 first.
# =============================================================================
# =============================================================================
...
penalty_tangent = 2.0e12   # 106_15: now the tangential stiffness AT sigma_ref, not a fixed penalty. Was 1e13.
...
exodus_file_base = results_exodus_hpc_rorqual/106_15_swt2_ktbb_kref2p0e12_ppfix_hpc
csv_file_base    = results_csv_hpc_rorqual/106_15_swt2_ktbb_kref2p0e12_ppfix_hpc
checkpoint_file_base = results_checkpoint_hpc_rorqual/106_15_swt2_ktbb_kref2p0e12_ppfix_hpc
...
[Materials]
  ...
  [czm_contact]
    ...
    use_stress_dependent_tangential_stiffness = true   # 106_15: Barton-Bandis k_s ~ sigma'_n, see header.
