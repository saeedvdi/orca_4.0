...
#
# Historical construction: 94_03 was built from the 93-series BBFast sibling by
# replacing [czm_contact]. This renamed center retains that MC shear law and
# aligns the later shared BBFast refinement documented above. The comparison
...
exodus_file_base = results_exodus/SWT2_OrcaMohrCoulombContactTraction
csv_file_base    = results_csv/SWT2_OrcaMohrCoulombContactTraction
checkpoint_file_base = results_checkpoint/SWT2_OrcaMohrCoulombContactTraction
...
[Materials]
  ...
  [czm_contact]
    ...
    # BBFast sibling 94_03_swt2_mc_final.i.
    #
