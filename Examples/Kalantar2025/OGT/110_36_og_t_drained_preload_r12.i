...
exodus_file_base = results_exodus_hpc/110_36_og_t_drained_preload_r12_hpc   # ROUND 12: self-named output
csv_file_base = results_csv_hpc/110_36_og_t_drained_preload_r12_hpc   # ROUND 12: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_36_og_t_drained_preload_r12_hpc   # ROUND 12: self-named output
...
[Functions]
  ...
  [injection_pressure]
    ...
    x = '0.0 14000.0'   # ROUND 12 PROBE: no injection schedule, the preload is the experiment
    y = '3000000.0 3000000.0'   # ROUND 12 PROBE: held at production_pressure, zero drive
  []

  [event_dt_cap]
    type = PiecewiseConstant
    x = '0 2.0'   # ROUND 12 PROBE: coarse throughout, no event to resolve
    y = '25.0 25.0'   # ROUND 12 PROBE: see x above
  []
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 14000   # ROUND 12: the drained preload alone
  ...
  [TimeSteppers]
    [adaptive]
      ...
      time_t = '0.0 0.5 2.0 10000.0 14000.0'   # ROUND 12: coarse drained preload, then the parent's own segments
      time_dt = '0.50 0.50 25.00 25.00 25.00'   # ROUND 12: see time_t above
  ...
  dtmax = 25.0   # ROUND 12: segment limits govern
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
