...
#SBATCH --job-name=110_16_og_t_traction_probe_r7
...
#SBATCH --mem=32G
#SBATCH --output=logs/110_16_og_t_traction_probe_r7_%j.out
#SBATCH --error=logs/110_16_og_t_traction_probe_r7_%j.err
