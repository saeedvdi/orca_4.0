##############################################################################
# 110_47_og_t_lineport_drainends_r13
...
#   pore pressure held at 3 MPa on top_nodeset / bottom_nodeset
#   preload ramp back to 53 s; probe ends at 600 s
#
# Line ports PLUS pore pressure held at 3 MPa on the end platens. Only meaningful if 110_46 fails: it says the specimen also needs axial drainage, which is a claim about Kalantar's apparatus that the reading notes do NOT confirm. Read it as a bound, not a model.
##############################################################################
# =============================================================================
...
exodus_file_base = results_exodus_hpc/110_47_og_t_lineport_drainends_r13_hpc   # ROUND 13: self-named output
csv_file_base = results_csv_hpc/110_47_og_t_lineport_drainends_r13_hpc   # ROUND 13: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_47_og_t_lineport_drainends_r13_hpc   # ROUND 13: self-named output
...
[BCs]
  ...
  [drain_top]
    # ROUND 13: pore pressure held at the production value on the end platens. This is
