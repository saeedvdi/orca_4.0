# =============================================================================
# 110_11_og_t_preload_probe
#
# LOCAL DIAGNOSTIC, NOT AN HPC JOB. Cut from 110_11_og_t_bbfast_r5.i by
# scripts/build_110_kalantar_decks.py. 60 s at dt 0.5, Exodus every step
# -- about 120 steps. Run it on <= 24 ranks:
#
#   cd Examples/Kalantar2025/OGT
#   mpiexec -n 24 ../../../orca-opt -i 110_11_og_t_preload_probe.i
#
...
exodus_file_base = results_exodus_probe/110_11_og_t_preload_probe   # KALANTAR: probe, local
csv_file_base    = results_csv_probe/110_11_og_t_preload_probe   # KALANTAR: probe, local
checkpoint_file_base = results_checkpoint_probe/110_11_og_t_preload_probe   # KALANTAR: probe, local
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 60   # PROBE: the preload ramp only
  ...
  dtmax = 0.5   # PROBE: flat and fine through the preload
  dtmin = 1e-6
  l_max_its = 50
  l_tol = 1e-4
  nl_max_its = 70
