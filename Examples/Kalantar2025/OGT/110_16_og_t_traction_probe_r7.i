...
# 110_16_og_t_traction_probe_r7
#
# ROUND-7 HPC DIAGNOSTIC. Cut from 110_11_og_t_bbfast_r5.i by
# scripts/build_110_kalantar_decks.py. 60 s at dt 0.5, Exodus every step
# -- about 120 steps. Submit with the generated 32-rank HPC script:
#
#   cd Examples/Kalantar2025/OGT
#   mpiexec -n 24 ../../../orca-opt -i 110_16_og_t_traction_probe_r7.i
#
...
exodus_file_base = results_exodus_probe/110_16_og_t_traction_probe_r7   # KALANTAR: probe, local
csv_file_base    = results_csv_probe/110_16_og_t_traction_probe_r7   # KALANTAR: probe, local
checkpoint_file_base = results_checkpoint_probe/110_16_og_t_traction_probe_r7   # KALANTAR: probe, local
