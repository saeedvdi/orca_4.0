# =============================================================================
# 110_14_og_t_preload_probe
#
# DIAGNOSTIC, NOT A FULL TABLE-2 RUN. Cut from 110_14_og_t_bbfast_r6.i by
# scripts/build_110_kalantar_decks.py. 60 s at dt 0.5, Exodus every step
# -- about 120 steps. Round 6 supplies a 64-rank HPC script.
#
...
exodus_file_base = results_exodus_probe/110_14_og_t_preload_probe   # KALANTAR: preload probe
csv_file_base    = results_csv_probe/110_14_og_t_preload_probe   # KALANTAR: preload probe
checkpoint_file_base = results_checkpoint_probe/110_14_og_t_preload_probe   # KALANTAR: preload probe
