# =============================================================================
# 110_08_og_t_bbfast_r4
#
# KALANTAR ET AL. (2025), specimen OG-T (tensile fracture) -- ROUND 4.
...
axial_pres_final = -7.056216e-04   # KALANTAR: GATED series-spring: sigma_1/penalty + C_ax*(sigma_1-sigma_3), sigma_1 = 193.43 MPa, C_ax = 1.4265e-12 m/Pa
...
exodus_file_base = results_exodus_hpc/110_08_og_t_bbfast_r4_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_08_og_t_bbfast_r4_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_08_og_t_bbfast_r4_hpc   # KALANTAR: self-named
