# =============================================================================
# 110_04_og_t_bbfast_r3
#
# KALANTAR ET AL. (2025), specimen OG-T (tensile fracture) -- ROUND 3.
...
#   residual         phi = 27.414 deg, atan of Table 2's LAST stage
#                    (tau 20.41 / sigma'_n 39.35 MPa). Round 1 carried the
...
#   D_c              150.0 um against a stick-slip cap of 310.4 um
#                    (D_c < d(tau)/k_eff, k_eff = K_sys cos^2 theta sin theta / A =
#                    0.1485 MPa/um). D_c < cap -> UNSTABLE, which is what the paper reports.
...
exodus_file_base = results_exodus_hpc/110_04_og_t_bbfast_r3_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_04_og_t_bbfast_r3_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_04_og_t_bbfast_r3_hpc   # KALANTAR: self-named
