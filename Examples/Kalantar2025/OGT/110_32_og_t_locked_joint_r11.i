...
exodus_file_base = results_exodus_hpc/110_32_og_t_locked_joint_r11_hpc   # ROUND 11: self-named
csv_file_base     = results_csv_hpc/110_32_og_t_locked_joint_r11_hpc   # ROUND 11: self-named
checkpoint_file_base = results_checkpoint_hpc/110_32_og_t_locked_joint_r11_hpc   # ROUND 11: self-named
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 1.0e9   # ROUND 11 NULL: joint locked, measures ELASTIC stress transfer with zero slip
    residual_cohesion = 1.0e9   # ROUND 11 NULL: joint locked, see peak cohesion above
    use_dilatancy = true
