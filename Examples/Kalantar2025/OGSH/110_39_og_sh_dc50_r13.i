...
#
#   characteristic_slip_distance = 5.0e-05
#       D_c 100 -> 50 um: slip freezes at 27.4 um, only 27 % of the current D_c, so weakening never engages
#
# Predicts d_s past 30 um and tau at stage 9 below 21.0.
##############################################################################
# =============================================================================
...
exodus_file_base = results_exodus_hpc/110_39_og_sh_dc50_r13_hpc   # ROUND 13: self-named output
csv_file_base = results_csv_hpc/110_39_og_sh_dc50_r13_hpc   # ROUND 13: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_39_og_sh_dc50_r13_hpc   # ROUND 13: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    characteristic_slip_distance = 5.0e-05   # ROUND 13: D_c 100 -> 50 um: slip freezes at 27.4 um, only 27 % of the current D_c, so weakening never engages
