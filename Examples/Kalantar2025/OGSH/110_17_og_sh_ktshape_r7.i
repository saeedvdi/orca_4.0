# =============================================================================
# 110_17_og_sh_ktshape_r7
#
# KALANTAR 2025 ROUND 7 -- OG-SH STRESS-DEPENDENT SHEAR-STIFFNESS PROBE.
#
...
# This diagnostic stops at t=2000 s.
#
# PASS GATE: stage-5 slip 30-60 um, tau error below +8%, and no burst.
# =============================================================================
...
exodus_file_base = results_exodus_hpc/110_17_og_sh_ktshape_r7_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_17_og_sh_ktshape_r7_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_17_og_sh_ktshape_r7_hpc   # KALANTAR: self-named
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 2000   # ROUND 7 diagnostic horizon
