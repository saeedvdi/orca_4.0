...
#
#   characteristic_slip_distance = 3.0e-05
#       as 110_40
#   cohesion = 6.0e+05
#       1.2 -> 0.6 MPa: D_c sets how FAST tau sheds, cohesion sets the LEVEL it sheds from; the two are separable only if both are moved
#
# Separates rate from level. If 110_40 fixes the late stages but leaves a uniform tau offset, this is the arm that removes it.
##############################################################################
# =============================================================================
...
exodus_file_base = results_exodus_hpc/110_42_og_sh_dc30_coh0p6_r13_hpc   # ROUND 13: self-named output
csv_file_base = results_csv_hpc/110_42_og_sh_dc30_coh0p6_r13_hpc   # ROUND 13: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_42_og_sh_dc30_coh0p6_r13_hpc   # ROUND 13: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    characteristic_slip_distance = 3.0e-05   # ROUND 13: as 110_40
    ...
    cohesion = 6.0e+05   # ROUND 13: 1.2 -> 0.6 MPa: D_c sets how FAST tau sheds, cohesion sets the LEVEL it sheds from; the two are separable only if both are moved
