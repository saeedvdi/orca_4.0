...
#
#   characteristic_slip_distance = 1.5e-05
#       D_c 100 -> 15 um: the over-weakened bound
#
# Deliberately expected to OVERSHOOT. A ladder with no arm past the answer cannot show the answer is bracketed.
##############################################################################
# =============================================================================
...
exodus_file_base = results_exodus_hpc/110_41_og_sh_dc15_r13_hpc   # ROUND 13: self-named output
csv_file_base = results_csv_hpc/110_41_og_sh_dc15_r13_hpc   # ROUND 13: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_41_og_sh_dc15_r13_hpc   # ROUND 13: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    characteristic_slip_distance = 1.5e-05   # ROUND 13: D_c 100 -> 15 um: the over-weakened bound
