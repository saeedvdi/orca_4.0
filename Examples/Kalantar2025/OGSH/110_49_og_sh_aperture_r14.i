...
#
# ISOLATES the aperture lever at the control's D_c. tau and d_s should barely move -- the aperture law does not feed the joint strength -- while a_h on the unloading branch should fall 0.61 um instead of the control's 0.029. If tau moves materially, the two laws are coupled more than assumed and the combined arms below cannot be read as a sum.
##############################################################################
##############################################################################
...
exodus_file_base = results_exodus_hpc/110_49_og_sh_aperture_r14_hpc   # ROUND 14: self-named output
csv_file_base = results_csv_hpc/110_49_og_sh_aperture_r14_hpc   # ROUND 14: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_49_og_sh_aperture_r14_hpc   # ROUND 14: self-named output
