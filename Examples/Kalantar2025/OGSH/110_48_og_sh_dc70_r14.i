...
#       round 13 bracketed the answer between 100 and 50 um; d_s interpolates to 69.5 and tau to 65.7, so 70 is the top of the joint interval
#
# ISOLATES the mechanical lever. Expect d_s@st9 ~ 42 um and tau@st9 ~ 19.0. Q should stay near the control's 9.3 % or drift slightly worse -- if it collapses, the gouge coupling is the cause and 110_49 is the arm that says so.
##############################################################################
##############################################################################
...
exodus_file_base = results_exodus_hpc/110_48_og_sh_dc70_r14_hpc   # ROUND 14: self-named output
csv_file_base = results_csv_hpc/110_48_og_sh_dc70_r14_hpc   # ROUND 14: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_48_og_sh_dc70_r14_hpc   # ROUND 14: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    characteristic_slip_distance = 7.00e-05   # ROUND 14: round 13 bracketed the answer between 100 and 50 um; d_s interpolates to 69.5 and tau to 65.7, so 70 is the top of the joint interval
