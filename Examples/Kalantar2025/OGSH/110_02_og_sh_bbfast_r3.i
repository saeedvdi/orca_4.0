# =============================================================================
# 110_02_og_sh_bbfast_r3
#
# KALANTAR ET AL. (2025), specimen OG-SH (shear fracture) -- ROUND 3.
...
#   measurement behind it, so it is the LAST thing to touch, not the first.
#
...
exodus_file_base = results_exodus_hpc/110_02_og_sh_bbfast_r3_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_02_og_sh_bbfast_r3_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_02_og_sh_bbfast_r3_hpc   # KALANTAR: self-named
