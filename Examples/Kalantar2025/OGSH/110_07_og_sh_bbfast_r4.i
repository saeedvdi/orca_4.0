# =============================================================================
# 110_07_og_sh_bbfast_r4
#
# KALANTAR ET AL. (2025), specimen OG-SH (shear fracture) -- ROUND 4.
...
#   D_c              59.3 um -- fitted to Table 2's mu(s) path over 6 sliding stages, RMS 0.281 MPa.
...
exodus_file_base = results_exodus_hpc/110_07_og_sh_bbfast_r4_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_07_og_sh_bbfast_r4_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_07_og_sh_bbfast_r4_hpc   # KALANTAR: self-named
...
[Materials]
  ...
  [czm_contact]
    ...
    characteristic_slip_distance = 5.933e-05   
