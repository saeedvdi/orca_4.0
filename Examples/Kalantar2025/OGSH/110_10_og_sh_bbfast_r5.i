# =============================================================================
# 110_10_og_sh_bbfast_r5
#
# KALANTAR ET AL. (2025), specimen OG-SH (shear fracture) -- ROUND 5.
...
#   D_c              150.0 um -- HELD at round 3's value, reverted to round 3's value: its round-4 bracket splits (tau wants 110 um, slip 166) and a split means a second defect -- the frame. Re-bracket only after the frame fix is verified.
...
exodus_file_base = results_exodus_hpc/110_10_og_sh_bbfast_r5_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_10_og_sh_bbfast_r5_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_10_og_sh_bbfast_r5_hpc   # KALANTAR: self-named
