...
#
#   cohesion = 6.0e+05
#       0 -> 0.6 MPa: surviving stage 6 needs tau_limit up ~0.56 MPa at sigma'_n = 26.26; stages 1-5 are far from the limit and do not move
#
# Predicts the burst moves from stage 6 to stage 7, matching the experiment. THE gate arm for OG-SC.
##############################################################################
# =============================================================================
...
# --- output ---
exodus_file_base = results_exodus_hpc/110_43_og_sc_coh0p6_r13_hpc   # ROUND 13: self-named output
csv_file_base = results_csv_hpc/110_43_og_sc_coh0p6_r13_hpc   # ROUND 13: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_43_og_sc_coh0p6_r13_hpc   # ROUND 13: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 6.0e+05   # ROUND 13: 0 -> 0.6 MPa: surviving stage 6 needs tau_limit up ~0.56 MPa at sigma'_n = 26.26; stages 1-5 are far from the limit and do not move
