...
#
#   slip_weakening_residual_friction_angle_degrees = 22.660
#       22.200 -> 22.660, which is this deck's own residual_friction_angle_degrees. A slip-weakening FLOOR above the basic friction angle would mean slip strengthens the joint, so this is the physical ceiling
#
# Round 13 moved this 21.175 -> 22.200 and mean 29 -> 23. Linear extrapolation of the unloading-branch tau asks for 24.79 deg, past the ceiling, so this arm is EXPECTED TO FALL SHORT of the target. Its job is to show the lever is exhausted.
##############################################################################
##############################################################################
...
# --- output ---
exodus_file_base = results_exodus_hpc/110_52_og_sc_swres22p66_r14_hpc   # ROUND 14: self-named output
csv_file_base = results_csv_hpc/110_52_og_sc_swres22p66_r14_hpc   # ROUND 14: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_52_og_sc_swres22p66_r14_hpc   # ROUND 14: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    slip_weakening_residual_friction_angle_degrees = 22.660   # ROUND 14: 22.200 -> 22.660, which is this deck's own residual_friction_angle_degrees. A slip-weakening FLOOR above the basic friction angle would mean slip strengthens the joint, so this is the physical ceiling
