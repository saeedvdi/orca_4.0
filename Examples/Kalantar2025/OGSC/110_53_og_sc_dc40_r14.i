##############################################################################
# 110_53_og_sc_dc40_r14
# GENERATED BY scripts/build_110_kalantar_round14_decks.py  -- do not hand-edit; regenerate instead.
# Parent: Examples/Kalantar2025/OGSC/110_45_og_sc_coh0p6_swres22p2_r13.i
#
#   characteristic_slip_distance = 4.00e-05
#       15.22 -> 40 um. The model still bursts at stage 6 (P_i = 21) where the experiment survives to stage 7 (P_i = 24). Cohesion cannot delay it (110_43/110_44 refuted). D_c sets the slip-weakening SLOPE, and a burst is the weakening slope exceeding the machine stiffness -- so raising D_c is the lever that acts on stability rather than on strength level
#
# The OG-SH lesson applied to OG-SC. The deck's round-3 note says D_c cannot be resolved here from the mu(s) path, and that is true -- but burst TIMING and burst SIZE do constrain it, which is a different argument and a legitimate one.
##############################################################################
##############################################################################
# 110_45_og_sc_coh0p6_swres22p2_r13
# GENERATED BY scripts/build_110_kalantar_round13_decks.py  -- do not hand-edit; regenerate instead.
# Parent: Examples/Kalantar2025/OGSC/110_15_og_sc_bbfast_r6.i
#
#   cohesion = 6.0e+05
#       as 110_43
#   slip_weakening_residual_friction_angle_degrees = 22.200
#       21.175 -> 22.200: the model's burst runs to 45 um against the experiment's 22, so it over-weakens once it goes
#
# Timing and size of the burst are different parameters. This arm fixes the size only if 110_43 has already fixed the timing.
##############################################################################
# =============================================================================
...
# --- output ---
exodus_file_base = results_exodus_hpc/110_53_og_sc_dc40_r14_hpc   # ROUND 14: self-named output
csv_file_base = results_csv_hpc/110_53_og_sc_dc40_r14_hpc   # ROUND 14: self-named output
checkpoint_file_base = results_checkpoint_hpc/110_53_og_sc_dc40_r14_hpc   # ROUND 14: self-named output
...
[Materials]
  ...
  [czm_contact]
    ...
    cohesion = 6.0e+05   # ROUND 13: as 110_43
    ...
    characteristic_slip_distance = 4.00e-05   # ROUND 14: 15.22 -> 40 um. The model still bursts at stage 6 (P_i = 21) where the experiment survives to stage 7 (P_i = 24). Cohesion cannot delay it (110_43/110_44 refuted). D_c sets the slip-weakening SLOPE, and a burst is the weakening slope exceeding the machine stiffness -- so raising D_c is the lever that acts on stability rather than on strength level
    slip_weakening_exponent = 1.4
    slip_weakening_residual_friction_angle_degrees = 22.200   # ROUND 13: 21.175 -> 22.200: the model's burst runs to 45 um against the experiment's 22, so it over-weakens once it goes
