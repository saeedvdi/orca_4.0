# =============================================================================
# 110_06_og_sc_bbfast_r3
#
# KALANTAR ET AL. (2025), specimen OG-SC (saw-cut fracture) -- ROUND 3.
...
#   residual         phi = 15.354 deg, atan of Table 2's LAST stage
#                    (tau 9.30 / sigma'_n 33.87 MPa). Round 1 carried the
...
#   D_c              15.2 um against a stick-slip cap of 25.4 um
#                    (D_c < d(tau)/k_eff, k_eff = K_sys cos^2 theta sin theta / A =
#                    0.1521 MPa/um). D_c < cap -> UNSTABLE, which is what the paper reports.
...
#   Secondary, NOT a falsifier: the measured drop is 3.4 MPa and round 2 shed 9.1.
#
...
# --- output ---
exodus_file_base = results_exodus_hpc/110_06_og_sc_bbfast_r3_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_06_og_sc_bbfast_r3_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_06_og_sc_bbfast_r3_hpc   # KALANTAR: self-named
...
[Materials]
  ...
  [czm_contact]
    ...
    slip_weakening_residual_friction_angle_degrees = 15.354   
