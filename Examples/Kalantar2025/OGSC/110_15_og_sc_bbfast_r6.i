# =============================================================================
# 110_15_og_sc_bbfast_r6
#
# KALANTAR ET AL. (2025), specimen OG-SC (saw-cut fracture) -- ROUND 6.
...
#   Closure V_m/K_ni, residual angle, frame and D_c are held.
#
...
# --- output ---
exodus_file_base = results_exodus_hpc/110_15_og_sc_bbfast_r6_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_15_og_sc_bbfast_r6_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_15_og_sc_bbfast_r6_hpc   # KALANTAR: self-named
...
[Materials]
  ...
  [czm_contact]
    ...
    tangential_viscosity = 2.0000e+12   # ROUND 6: 5x arm; delay pre-burst creep
    min_tau_limit = 0.0
...
[Executioner]
  ...
  line_search = l2
  start_time = 0
  end_time = 9100   # FULL SW-S3 cycle (11 stages, ~430 s each)
