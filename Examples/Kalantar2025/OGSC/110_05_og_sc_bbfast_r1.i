# =============================================================================
# 110_05_og_sc_bbfast_r1
#
# KALANTAR ET AL. (2025), specimen OG-SC (saw-cut fracture) -- ROUND 2.
...
#   peak envelope    tau = 0.4 sigma'_n + 0.0 MPa (Figure 3)
#                    -> phi_peak 21.80 deg at the stage-1 sigma'_n of
...
#   OG-SC slips in one burst at the top of the staircase.
...
# --- output ---
exodus_file_base = results_exodus_hpc/110_05_og_sc_bbfast_r1_hpc   # KALANTAR: self-named
csv_file_base    = results_csv_hpc/110_05_og_sc_bbfast_r1_hpc   # KALANTAR: self-named
checkpoint_file_base = results_checkpoint_hpc/110_05_og_sc_bbfast_r1_hpc   # KALANTAR: self-named
...
[Materials]
  ...
  [czm_contact]
    ...
    residual_friction_angle_degrees = 19.148   # pins the envelope through Table 2's last stick stage (23.42 MPa, 14.26 MPa) at the measured JRC/JCS. Was 8.45.
