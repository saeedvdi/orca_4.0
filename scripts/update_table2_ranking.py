...
NEW_CASES = [
    ...
    {
        "sample": "SWT1",
        "case": "105_01_swt1_vm70um_ppfix",
        "series": "105",
        "model_family": "BBFast",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWT1/results_csv_hpc_rorqual/105_01_swt1_vm70um_ppfix_hpc.csv",
        "notes": "mechanical BB maximum closure 55->70 um; closes the V_m bracket above 100_01 -- the arm turns and regresses",
    },
    {
        "sample": "SWT1",
        "case": "105_02_swt1_vm90um_ppfix",
        "series": "105",
        "model_family": "BBFast",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWT1/results_csv_hpc_rorqual/105_02_swt1_vm90um_ppfix_hpc.csv",
        "notes": "V_m 90 um; the slip event never fires (0.0156 mm slip vs 0.537 measured) -- past the cliff, not a calibration point",
    },
    {
        "sample": "SWT1",
        "case": "105_03_swt1_vm110um_ppfix",
        "series": "105",
        "model_family": "BBFast",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWT1/results_csv_hpc_rorqual/105_03_swt1_vm110um_ppfix_hpc.csv",
        "notes": "V_m 110 um; slip event never fires, same failure mode as 105_02",
    },
    {
        "sample": "SWS4",
        "case": "105_04_sw4_dc4p5em5_ppfix",
        "series": "105",
        "model_family": "BBFast",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWS4/results_csv_hpc_rorqual/105_04_sw4_dc4p5em5_ppfix_hpc.csv",
        "notes": "characteristic slip distance 74.5->45 um; fixes stage 4 then runs away at stage 5 -- D_c was already inside the Table-2 implied 55-98 um bracket",
    },
    {
        "sample": "SWS4",
        "case": "105_05_sw4_swfloor3p15_ppfix",
        "series": "105",
        "model_family": "BBFast",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWS4/results_csv_hpc_rorqual/105_05_sw4_swfloor3p15_ppfix_hpc.csv",
        "notes": "slip-weakening residual floor 6.50->3.15 deg; the parent's unloading floor was already right (tau error decays to +0.05 MPa)",
    },
    {
        "sample": "SWS4",
        "case": "105_06_sw4_dc4p5em5_swfloor3p15_ppfix",
        "series": "105",
        "model_family": "BBFast",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWS4/results_csv_hpc_rorqual/105_06_sw4_dc4p5em5_swfloor3p15_ppfix_hpc.csv",
        "notes": "105_04 + 105_05 corner; both singles regressed and the corner compounds them",
    },
    {
        "sample": "SWS4",
        "case": "105_07_sw4_mc_calib_ppfix",
        "series": "105",
        "model_family": "MC",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWS4/results_csv_hpc_rorqual/105_07_sw4_mc_calib_ppfix_hpc.csv",
        "notes": "MC transfer arm with calibrated strength; regresses against the 94_07 MC baseline",
    },
    {
        "sample": "SWS4",
        "case": "105_08_sw4_mc_calib_rsf_ppfix",
        "series": "105",
        "model_family": "MC",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWS4/results_csv_hpc_rorqual/105_08_sw4_mc_calib_rsf_ppfix_hpc.csv",
        "notes": "MC transfer arm with calibrated strength plus rate-and-state; regresses further than 105_07",
    },
    {
        "sample": "SWS3",
        "case": "105_09_sw3_mc_calib_ppfix",
        "series": "105",
        "model_family": "MC",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
        "source_csv": "Examples/YeGhasemmi2018/SWS3/results_csv_hpc_rorqual/105_09_sw3_mc_calib_ppfix_hpc.csv",
        "notes": "MC transfer arm with calibrated strength; regresses against the 94_05 MC baseline",
    },
    {
        "sample": "SWS3",
        "case": "105_10_sw3_mc_calib_rsf_ppfix",
        "series": "105",
        "model_family": "MC",
        "mesh": "mesh5",
        "selection_status": "targeted_calibration_probe",
